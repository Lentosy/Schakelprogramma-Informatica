...
\end{itemize}
\section{Functies van de exponentiÃ«le orde}
\begin{itemize}[label={}]
 \item{
    \exercise{
            Geef de exponentiÃ«le orde van $f(t) = te^{-2t}$
    }{
            \begin{equation*}
             \begin{split}
            ...
            \begin{equation*}
             ...
             \end{split}
            \end{equation*}
            De exponentiÃ«le orde is -2.
        }}
 \item{
    \exercise{
        Geef de exponentiÃ«le orde van $f(t) = 6e^{3t}$
    }{
        \begin{equation*}
         \begin{split}
         ...
         \end{split}
        \end{equation*}
        Indien $ 3 - \alpha < 0$ dan wordt de limiet 0. De exponentiÃ«le orde is dus 3.
    }
