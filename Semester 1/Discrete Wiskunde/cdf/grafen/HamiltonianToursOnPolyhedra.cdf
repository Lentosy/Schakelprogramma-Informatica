...
NotebookDataLength[     77274,       1520]
NotebookOptionsPosition[     50284,        941]
NotebookOutlinePosition[     76541,       1502]
CellTagsIndexPosition[     76430,       1496]
WindowTitle->Hamiltonian Tours on Polyhedra
WindowFrame->Normal*)
...
Cell["Hamiltonian Tours on Polyhedra", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`diameter$$ = 0.1, $CellContext`opacity$$ = 
    0.4, $CellContext`p$$ = "Icosahedron", Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`opacity$$], 0.4}, {0., 0.2, 0.4, 0.6, 0.8, 1}}, {{
       Hold[$CellContext`p$$], "Icosahedron", "polyhedron"}, {
      "Cube" -> "cube", "Dodecahedron" -> "dodecahedron", "Icosahedron" -> 
       "icosahedron", "Octahedron" -> "octahedron", "Tetrahedron" -> 
       "tetrahedron", Delimiter, "Cuboctahedron" -> "cuboctahedron", 
       "GreatRhombicosidodecahedron" -> "great rhombicosidodecahedron", 
       "GreatRhombicuboctahedron" -> "great rhombicuboctahedron", 
       "Icosidodecahedron" -> "icosidodecahedron", 
       "SmallRhombicosidodecahedron" -> "small rhombicosidodecahedron", 
       "SmallRhombicuboctahedron" -> "small rhombicuboctahedron", "SnubCube" -> 
       "snub cube", "SnubDodecahedron" -> "snub dodecahedron", 
       "TruncatedCube" -> "truncated cube", "TruncatedDodecahedron" -> 
       "truncated dodecahedron", "TruncatedIcosahedron" -> 
       "truncated icosahedron", "TruncatedOctahedron" -> 
       "truncated octahedron", "TruncatedTetrahedron" -> 
       "truncated tetrahedron"}}, {{
       Hold[$CellContext`diameter$$], 0.1, "tube diameter"}, {0.1, 
      0.30000000000000004`, 0.5, 0.7000000000000001, 0.9}}}, Typeset`size$$ = 
    Automatic, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`opacity$22739$$ = 
    0, $CellContext`p$22740$$ = False, $CellContext`diameter$22741$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`diameter$$ = 0.1, $CellContext`opacity$$ = 
        0.4, $CellContext`p$$ = "Icosahedron"}, "ControllerVariables" :> {
        Hold[$CellContext`opacity$$, $CellContext`opacity$22739$$, 0], 
        Hold[$CellContext`p$$, $CellContext`p$22740$$, False], 
        Hold[$CellContext`diameter$$, $CellContext`diameter$22741$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Graphics3D[
        With[{$CellContext`verts$ = 
          PolyhedronData[$CellContext`p$$, 
            "VertexCoordinates"], $CellContext`path$ = First[
            GraphUtilities`HamiltonianCycles[
             Apply[Rule, 
              PolyhedronData[$CellContext`p$$, "EdgeIndices"], {1}]]]}, {{
           Opacity[$CellContext`opacity$$], 
           First[
            PolyhedronData[$CellContext`p$$]]}, 
          Tube[
           Map[Part[$CellContext`verts$, #]& , 
            Flatten[{$CellContext`path$, 
              Part[$CellContext`path$, 1]}]], $CellContext`diameter$$]}], 
        Boxed -> False, SphericalRegion -> True], 
      "Specifications" :> {{{$CellContext`opacity$$, 0.4}, {
         0., 0.2, 0.4, 0.6, 0.8, 1}, ControlType -> 
         SetterBar}, {{$CellContext`p$$, "Icosahedron", "polyhedron"}, {
         "Cube" -> "cube", "Dodecahedron" -> "dodecahedron", "Icosahedron" -> 
          "icosahedron", "Octahedron" -> "octahedron", "Tetrahedron" -> 
          "tetrahedron", Delimiter, "Cuboctahedron" -> "cuboctahedron", 
          "GreatRhombicosidodecahedron" -> "great rhombicosidodecahedron", 
          ...
          "Icosidodecahedron" -> "icosidodecahedron", 
          "SmallRhombicosidodecahedron" -> "small rhombicosidodecahedron", 
          "SmallRhombicuboctahedron" -> "small rhombicuboctahedron", 
          "SnubCube" -> "snub cube", "SnubDodecahedron" -> 
          "snub dodecahedron", "TruncatedCube" -> "truncated cube", 
          ...
          "truncated tetrahedron"}}, {{$CellContext`diameter$$, 0.1, 
          "tube diameter"}, {0.1, 0.30000000000000004`, 0.5, 
         0.7000000000000001, 0.9}, ControlType -> SetterBar}}, 
      "Options" :> {SynchronousInitialization -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{272., {74., 79.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(Quiet[
       Get["GraphUtilities`"]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 ButtonBox["Hamiltonian Circuit",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/HamiltonianCircuit.html"], None},
...
Cell[TextData[{
 ButtonBox["Polyhedron",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Polyhedron.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/B-Spline.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
...
HamiltonianToursOnPolyhedra&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/\
HamiltonianToursOnPolyhedra-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Hamiltonian Tours on Polyhedra",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/"],
 "\"",
 ...
 ButtonBox["http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/HamiltonianToursOnPolyhedra/"]
}], "Citations"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40090, 687, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40351, 696, 1761, 40, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49462, 916, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76144, 1485},
 {"Copyright", 76339, 1490}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[594, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34925, 590, 51, 0, 70, "DemoTitle"],
Cell[34979, 592, 5004, 89, 70, "Output",
 CellID->19517515],
Cell[39986, 683, 101, 2, 70, "ManipulateCaption"],
Cell[40090, 687, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40351, 696, 1761, 40, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42115, 738, 44, 0, 70, "RelatedLinksSection"],
Cell[42162, 740, 637, 21, 70, "RelatedLinks",
 CellID->878943294],
Cell[42802, 763, 620, 21, 70, "RelatedLinks",
 CellID->543854544],
Cell[43425, 786, 4820, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48248, 877, 45, 0, 70, "CitationSection"],
Cell[48296, 879, 842, 23, 70, "Citations"],
Cell[49141, 904, 318, 10, 70, "Author"],
Cell[49462, 916, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature ZREmReZH1YawUxA5CFckyknG *)
