...
NotebookDataLength[     88570,       1801]
NotebookOptionsPosition[     61011,       1205]
NotebookOutlinePosition[     87263,       1766]
CellTagsIndexPosition[     87152,       1760]
WindowTitle->The Chinese Rings Puzzle
WindowFrame->Normal*)
...
Cell["The Chinese Rings Puzzle", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`moves$$ = 0, $CellContext`number$$ = 9, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`number$$], 9, "number of rings"}, 3, 9, 1}, {{
       Hold[$CellContext`moves$$], 0, "solution steps"}, 0, 
      Dynamic[Dynamic[
         Part[$CellContext`stepMax, $CellContext`number$$ - 2]] - 1], 1}}, 
    Typeset`size$$ = {500., {123., 127.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`number$70829$$ = 0, $CellContext`moves$70830$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`moves$$ = 0, $CellContext`number$$ = 9}, 
      "ControllerVariables" :> {
        Hold[$CellContext`number$$, $CellContext`number$70829$$, 0], 
        Hold[$CellContext`moves$$, $CellContext`moves$70830$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[$CellContext`moves$$ >= 
         Part[$CellContext`stepMax, $CellContext`number$$ - 
           2], $CellContext`moves$$ = 0]; $CellContext`ChineseRingsModel[
         Part[
          $CellContext`ChineseRingsSolve[$CellContext`number$$], \
$CellContext`moves$$ + 1]]), 
      "Specifications" :> {{{$CellContext`number$$, 9, "number of rings"}, 3, 
         9, 1, ControlType -> 
         Setter}, {{$CellContext`moves$$, 0, "solution steps"}, 0, 
         Dynamic[Dynamic[
            Part[$CellContext`stepMax, $CellContext`number$$ - 2]] - 1], 1, 
         AnimationDirection -> ForwardBackward, Appearance -> "Labeled"}}, 
      "Options" :> {TrackedSymbols -> True}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {179., 184.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`stepMax = {6, 11, 22, 43, 86, 171, 
         342}, $CellContext`ChineseRingsModel[
          Pattern[$CellContext`statues, 
           Blank[List]]] := 
        Module[{$CellContext`ringsNum = 
           Length[$CellContext`statues], $CellContext`handle2D, \
$CellContext`handle3D, $CellContext`links2DSingle, \
$CellContext`links3DSingle, $CellContext`links3DInitial, \
$CellContext`links3D, $CellContext`rings2DSingle, $CellContext`rings3DAll, \
$CellContext`rings3DRotate, $CellContext`rings3D, \
$CellContext`balls3DInitial, $CellContext`balls3D, $CellContext`lockPanel}, \
$CellContext`handle2D = {{-4, 0.4}, {-4.25, 
             0.75}, {-4.5, 1}, {-5, 0.5}, {-4.5, 0.1}, {-4, 0.1}, {-1.75, 
             0.1}, {-2, 0.1}, {-1.5, 1}, {0, 
             1}, {$CellContext`ringsNum, 1}, {$CellContext`ringsNum + 0.5, 
              1}, {$CellContext`ringsNum + 1, 0.5}, {$CellContext`ringsNum + 
              1, 0}}; $CellContext`handle3D = Map[Join[#, {0}]& , 
             Join[$CellContext`handle2D, 
              Reverse[
               Map[{
                 Part[#, 1], -
                 Part[#, 
                   2]}& , $CellContext`handle2D]]]]; \
$CellContext`links2DSingle = {{0, 1.1}, {0.25, 1.25}, {0.5, 1.5}, {0, 
             2}, {-0.5, 1.5}, {-0.25, 1.15}, {-0.1, 1.1}, {0, 1}, {
             0, -4}}; $CellContext`links3DSingle = 
           Map[Insert[#, 0, 
              2]& , $CellContext`links2DSingle]; $CellContext`links3DInitial = 
           Table[
             
             Map[{$CellContext`i, 
                0, -0.5} + #& , $CellContext`links3DSingle], {$CellContext`i, 
              0, $CellContext`ringsNum - 1}]; $CellContext`links3D = 
           MapIndexed[If[Part[$CellContext`statues, 
                First[#2]] == 1, #, 
              
              Map[{0, 0, -1} + #& , #]]& , $CellContext`links3DInitial]; \
$CellContext`rings2DSingle = Table[1.5 {
               Cos[$CellContext`a], 
               Sin[$CellContext`a]}, {$CellContext`a, 0.5 Pi, 2.5 Pi, Pi/
              8}]; $CellContext`rings3DAll = Table[
             Tube[
              BSplineCurve[
               Map[{$CellContext`i, 0, 0} + #& , 
                Map[Insert[#, 0, 1]& , $CellContext`rings2DSingle]], 
               0.15]], {$CellContext`i, 0, $CellContext`ringsNum - 
              1}]; $CellContext`rings3DRotate = 
           MapIndexed[Rotate[#, (-30) Degree, {0, 1, 0}, {
               First[#2], 0, 
               1}]& , $CellContext`rings3DAll]; $CellContext`rings3D = 
           MapIndexed[If[Part[$CellContext`statues, 
                First[#2]] == 1, #, 
              
              Translate[#, {0, 
               0, -1}]]& , $CellContext`rings3DRotate]; \
$CellContext`balls3DInitial = 
           Table[{$CellContext`i, 0, -4.5}, {$CellContext`i, 
              0, $CellContext`ringsNum - 1}]; $CellContext`balls3D = 
           MapIndexed[If[Part[$CellContext`statues, 
                First[#2]] == 
              1, #, {0, 
               0, -1} + #]& , $CellContext`balls3DInitial]; \
$CellContext`lockPanel = 
           Cuboid[{-1, -0.5, -3.75}, {$CellContext`ringsNum, 0.5, -3.5}]; 
          Graphics3D[{
             Specularity[White, 50], 
             CapForm["Round"], 
             Tube[
              BSplineCurve[$CellContext`handle3D, 0.15]], 
             Tube[
              
              BSplineCurve[$CellContext`links3D, 
               0.1]], $CellContext`rings3D, $CellContext`lockPanel, 
             GrayLevel[0.25], 
             Specularity[Yellow, 50], 
             Sphere[$CellContext`balls3D, 0.4]}, Lighting -> Automatic, 
            Background -> LightYellow, Boxed -> False, 
            ViewPoint -> {0, -10, 5}, ImageSize -> {500, 250}, 
            PlotRange -> {{-5, 10}, {-5, 5}, {-6, 2}}, PlotLabel -> Style[
              Row[{"binary Gray code: ", 
                StringJoin[
                 Map[ToString, $CellContext`statues]]}], Bold, 18]]], 
        Attributes[PlotRange] = {
         ReadProtected}, $CellContext`ChineseRingsSolve[
          Pattern[$CellContext`ringsNum, 
           Blank[]]] := 
        Module[{$CellContext`grayCodeList, $CellContext`usedList}, \
$CellContext`grayCodeList = Table[
             $CellContext`GrayCode[$CellContext`i], {$CellContext`i, 0, 
              2^$CellContext`ringsNum - 1}]; $CellContext`usedList = 
           Take[$CellContext`grayCodeList, 
             First[
              Flatten[
               Position[$CellContext`grayCodeList, 
                Table[1, {$CellContext`ringsNum}]]]]]; Reverse[
            Map[Join[
              Table[
              0, {$CellContext`ringsNum - 
                Length[#]}], #]& , $CellContext`usedList]]], \
$CellContext`GrayCode[
          Pattern[$CellContext`i, 
           Blank[]]] := Apply[BitXor, 
          Partition[
           Prepend[
            IntegerDigits[$CellContext`i, 2], 0], 2, 1], {1}]}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`ChineseRingsModel[
           Pattern[$CellContext`statues, 
            Blank[List]]] := 
         Module[{$CellContext`ringsNum = 
            Length[$CellContext`statues], $CellContext`handle2D, \
...
$CellContext`links2DSingle = {{0, 1.1}, {0.25, 1.25}, {0.5, 1.5}, {0, 
            ...
            MapIndexed[If[Part[$CellContext`statues, 
               ...
               Map[{0, 
                 0, -1} + #& , #]]& , $CellContext`links3DInitial]; \
$CellContext`rings2DSingle = Table[1.5 {
                Cos[$CellContext`a], 
                Sin[$CellContext`a]}, {$CellContext`a, 0.5 Pi, 2.5 Pi, Pi/
               8}]; $CellContext`rings3DAll = Table[
...
$CellContext`lockPanel = 
           ...
           Graphics3D[{
             ...
             PlotRange -> {{-5, 10}, {-5, 5}, {-6, 2}}, PlotLabel -> Style[
               Row[{"binary Gray code: ", 
                 StringJoin[
                  Map[ToString, $CellContext`statues]]}], Bold, 
               18]]], $CellContext`GrayCode[
           Pattern[$CellContext`i, 
            Blank[]]] := Apply[BitXor, 
           Partition[
            Prepend[
             IntegerDigits[$CellContext`i, 2], 0], 2, 1], {
           1}], $CellContext`ChineseRingsSolve[
           Pattern[$CellContext`ringsNum, 
            Blank[]]] := 
         Module[{$CellContext`grayCodeList, $CellContext`usedList}, \
$CellContext`grayCodeList = Table[
            ...
            Take[$CellContext`grayCodeList, 
             ...
             Map[Join[
               ...
               0, {$CellContext`ringsNum - 
                 Length[#]}], #]& , $CellContext`usedList]]], \
$CellContext`stepMax = {6, 11, 22, 43, 86, 171, 342}; Null}]]; 
...
Cell["\<\
The Chinese rings (or baguenaudier) is one of the oldest known mechanical \
puzzles. The object of the game is to remove all of the rings from the \
horizontal loop of handle.\
\>", "ManipulateCaption",
 CellID->175983364],
...
Cell["\<\
2) Any other ring can be removed or replaced if and only if the ring to its \
right is on the handle and all rings to the right of that one are off.\
\>", "ManipulateCaption",
 CellID->485154330],

Cell["\<\
The current state of ring can be represented in binary notation, writing 1 if \
a ring is on the handle and 0 if it is off. The solution uses the binary Gray \
code. \
\>", "ManipulateCaption",
 CellID->344946664],
...
Cell[TextData[{
 ...
 StyleBox["4",
  FontWeight->"Bold"],
 ", New York: Addison-Wesley, 2001 pp. 5\[Dash]6."
}], "DetailNotes",
 CellID->230759348],

Cell[TextData[{
 "[2] H. L. Wu, ",
 StyleBox["The Three Classical Puzzle of China",
  FontSlant->"Italic"],
 ", Beijing: Science Press, 2004 pp. 143\[Dash]186."
}], "DetailNotes",
 CellID->100196906],
...
Cell[TextData[{
 ButtonBox["Baguenaudier",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Baguenaudier.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/Baguenaudier.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Gray Code",
  ...
  ButtonNote->"http://mathworld.wolfram.com/GrayCode.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
TheChineseRingsPuzzle&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheChineseRingsPuzzle/\
TheChineseRingsPuzzle-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["The Chinese Rings Puzzle",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheChineseRingsPuzzle/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TheChineseRingsPuzzle/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/TheChineseRingsPuzzle/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheChineseRingsPuzzle/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TheChineseRingsPuzzle/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[48480, 891, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[48741, 900, 3610, 78, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[60189, 1180, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 86865, 1749},
 {"Copyright", 87060, 1754}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34967, 592, 12492, 262, 70, "Output",
 CellID->299558029],
Cell[47462, 856, 232, 5, 70, "ManipulateCaption",
 CellID->175983364],
Cell[47697, 863, 226, 8, 70, "ManipulateCaption",
 CellID->405854915],
Cell[47926, 873, 117, 3, 70, "ManipulateCaption",
 CellID->33245231],
Cell[48046, 878, 205, 4, 70, "ManipulateCaption",
 CellID->485154330],
Cell[48254, 884, 223, 5, 70, "ManipulateCaption",
 CellID->344946664],
Cell[48480, 891, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48741, 900, 3610, 78, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[52354, 980, 33, 0, 70, "DetailsSection"],
Cell[52390, 982, 52, 1, 70, "DetailNotes",
 CellID->57521559],
Cell[52445, 985, 246, 9, 70, "DetailNotes",
 CellID->230759348],
Cell[52694, 996, 199, 6, 70, "DetailNotes",
 CellID->100196906],
Cell[52896, 1004, 44, 0, 70, "RelatedLinksSection"],
Cell[52943, 1006, 628, 21, 70, "RelatedLinks",
 CellID->187527132],
Cell[53574, 1029, 617, 21, 70, "RelatedLinks",
 CellID->189642678],
Cell[54194, 1052, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[58999, 1143, 45, 0, 70, "CitationSection"],
Cell[59047, 1145, 792, 20, 70, "Citations"],
Cell[59842, 1167, 344, 11, 70, "Author",
 CellID->489187369],
Cell[60189, 1180, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature BRqbL3XiZH68UvQNfpL103ME *)
