...
NotebookDataLength[     74146,       1466]
NotebookOptionsPosition[     47373,        892]
NotebookOutlinePosition[     73399,       1447]
CellTagsIndexPosition[     73326,       1442]
WindowTitle->Pr\374fer Codes of Labeled Trees
WindowFrame->Normal*)
...
Cell["Pr\[UDoubleDot]fer Codes of Labeled Trees", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 1000000, $CellContext`nodes$$ = 9, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`nodes$$], 9}, 3, 10, 1}, {{
       Hold[$CellContext`k$$], 1000000, "pick a tree"}, 1, 
      Dynamic[$CellContext`nodes$$^($CellContext`nodes$$ - 2)], 1}}, 
    Typeset`size$$ = Automatic, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`nodes$1341$$ = 
    0, $CellContext`k$1342$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 1000000, $CellContext`nodes$$ = 9}, 
      "ControllerVariables" :> {
        Hold[$CellContext`nodes$$, $CellContext`nodes$1341$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$1342$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[$CellContext`k$$ > $CellContext`nodes$$^($CellContext`nodes$$ - 
           2), $CellContext`k$$ = $CellContext`nodes$$^($CellContext`nodes$$ - 
           2)]; If[$CellContext`root > $CellContext`nodes$$, \
$CellContext`root = 1]; 
       With[{$CellContext`code = 
          IntegerDigits[$CellContext`k$$, $CellContext`nodes$$, \
$CellContext`nodes$$ - 2] + 1}, 
         Column[{
           Text[$CellContext`code], 
           Show[
            $CellContext`ToLabeledGraph[
             Combinatorica`RootedEmbedding[
              Combinatorica`CodeToLabeledTree[$CellContext`code], 1]], 
            ImageSize -> {400, 400}]}, Alignment -> Center]]), 
      "Specifications" :> {{{$CellContext`nodes$$, 9}, 3, 10, 1, Appearance -> 
         "Labeled"}, {{$CellContext`k$$, 1000000, "pick a tree"}, 1, 
         Dynamic[$CellContext`nodes$$^($CellContext`nodes$$ - 2)], 1, 
         Appearance -> "Labeled"}}, 
      "Options" :> {SynchronousInitialization -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{334., {64., 69.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>((Quiet[
        Get["Combinatorica`"]]; $CellContext`ToLabeledGraph[
         Pattern[$CellContext`g, 
          Blank[]]] := GraphPlot[
         Apply[Rule, 
          Map[First, 
           Part[$CellContext`g, 1]], {1}], VertexLabeling -> True, 
         VertexCoordinateRules -> Thread[Range[
             Length[
              Part[$CellContext`g, 2]]] -> Map[First, 
             Part[$CellContext`g, 2]]]]; Null); Typeset`initDone$$ = True),
...
Cell[TextData[{
 ...
 " nodes. In 1918, Pr\[UDoubleDot]fer found a method for constructing each \
tree. "
}], "ManipulateCaption"],

Cell["\<\
Consider the tree with code {2, 8, 9, 4, 7, 7, 2} that is given as the \
default tree in this Demonstration. The first digit of the Pr\[UDoubleDot]fer \
code is the branch that has the smallest isolated number. Pruning that branch \
gives a new tree, and the process repeats, as shown in the Details.\
\>", "ManipulateCaption",
 CellID->511865123],
...
PruferCodesOfLabeledTrees&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/\
PruferCodesOfLabeledTrees-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Pr\[UDoubleDot]fer Codes of Labeled Trees",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PruferCodesOfLabeledTrees/"]
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Pr\[UDoubleDot]fer Codes of Labeled Trees",
DockedCells->{},
...
CellTagsIndex->{
 "Copyright"->{
  Cell[46551, 867, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 73235, 1436}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[596, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34927, 590, 62, 0, 70, "DemoTitle"],
Cell[34992, 592, 3157, 66, 70, "Output",
 CellID->438784201],
Cell[38152, 660, 369, 11, 70, "ManipulateCaption"],
Cell[38524, 673, 357, 6, 70, "ManipulateCaption",
 CellID->511865123],
Cell[38884, 681, 33, 0, 70, "DetailsSection"],
Cell[38920, 683, 421, 9, 70, "DetailNotes",
 CellID->142012332],
Cell[39344, 694, 44, 0, 70, "RelatedLinksSection"],
Cell[39391, 696, 574, 20, 70, "RelatedLinks",
 CellID->391245178],
Cell[39968, 718, 562, 20, 70, "RelatedLinks",
 CellID->63925059],
Cell[40533, 740, 4814, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[45350, 831, 45, 0, 70, "CitationSection"],
Cell[45398, 833, 829, 20, 70, "Citations"],
Cell[46230, 855, 318, 10, 70, "Author"],
Cell[46551, 867, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature CSUnBPYdp81aFwmAwDwjeHcu *)
