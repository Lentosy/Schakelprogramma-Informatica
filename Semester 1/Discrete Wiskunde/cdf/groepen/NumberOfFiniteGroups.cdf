...
NotebookDataLength[     74403,       1477]
NotebookOptionsPosition[     47699,        904]
NotebookOutlinePosition[     73707,       1459]
CellTagsIndexPosition[     73634,       1454]
WindowTitle->Number of Finite Groups
WindowFrame->Normal*)
...
Cell["Number of Finite Groups", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`labs$$ = True, $CellContext`mesh$$ = 
    True, $CellContext`n$$ = 10, $CellContext`ords$$ = True, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 10, "table size"}, 2, 15, 1}, {{
       Hold[$CellContext`labs$$], True, "show all Abelian groups"}, {
      True, False}}, {{
       Hold[$CellContext`mesh$$], True, "show mesh"}, {True, False}}, {{
       Hold[$CellContext`ords$$], True, "show orders"}, {True, False}}}, 
    Typeset`size$$ = {360., {178., 181.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`n$1207910$$ = 0, $CellContext`labs$1207911$$ = 
    False, $CellContext`mesh$1207912$$ = False, $CellContext`ords$1207913$$ = 
    False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`labs$$ = True, $CellContext`mesh$$ = 
        True, $CellContext`n$$ = 10, $CellContext`ords$$ = True}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$1207910$$, 0], 
        Hold[$CellContext`labs$$, $CellContext`labs$1207911$$, False], 
        Hold[$CellContext`mesh$$, $CellContext`mesh$1207912$$, False], 
        Hold[$CellContext`ords$$, $CellContext`ords$1207913$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Partition[
         Array[
         If[$CellContext`labs$$, FiniteGroupCount[#] == 
           FiniteAbelianGroupCount[#], 
           False]& , $CellContext`n$$^2], $CellContext`n$$], 
        Mesh -> $CellContext`mesh$$, MeshStyle -> Green, 
        ColorRules -> {
         True -> Lighter[Red, 0.4], False -> Lighter[Blue, 0.9]}, Epilog -> 
        If[$CellContext`ords$$, 
          Table[
           Text[
            Labeled[
             Style[
              ...
              FiniteGroupCount[($CellContext`i - 
                 1) $CellContext`n$$ + $CellContext`j], 200/$CellContext`n$$], 
             
             Style[($CellContext`i - 1) $CellContext`n$$ + $CellContext`j, 
              80/$CellContext`n$$]], {$CellContext`j - 
              1, $CellContext`n$$ - $CellContext`i} + 
            1/2], {$CellContext`i, $CellContext`n$$}, {$CellContext`j, \
$CellContext`n$$}], 
          Table[
           Text[
            Style[
             ...
             200/$CellContext`n$$], {$CellContext`j - 
              1, $CellContext`n$$ - $CellContext`i} + 
            1/2], {$CellContext`i, $CellContext`n$$}, {$CellContext`j, \
$CellContext`n$$}]]], 
      "Specifications" :> {{{$CellContext`n$$, 10, "table size"}, 2, 15, 1, 
         Appearance -> 
         "Labeled"}, {{$CellContext`labs$$, True, 
          "show all Abelian groups"}, {True, False}}, 
        Delimiter, {{$CellContext`mesh$$, True, "show mesh"}, {
         True, False}}, {{$CellContext`ords$$, True, "show orders"}, {
         True, False}}}, "Options" :> {}, 
...
Cell["\<\
Show the number of finite groups for a given order, highlighting the ones \
that are all Abelian groups. \
\>", "ManipulateCaption"],

Cell["DETAILS", "DetailsSection"],

Cell[TextData[{
 "J. H. Conway, H. Dietrich, and E. A. O'Brien, \"Counting Groups: Gnus, Moas \
and Other Exotica,\" ",
 StyleBox["Mathematical Intelligencer",
  FontSlant->"Italic"],
 ", ",
 StyleBox["30",
  FontWeight->"Bold"],
...
Cell[TextData[{
 ButtonBox["Finite Group",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/FiniteGroup.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/FiniteGroup.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
NumberOfFiniteGroups&version=0005"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/NumberOfFiniteGroups/\
NumberOfFiniteGroups-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/NumberOfFiniteGroups/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/NumberOfFiniteGroups/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/NumberOfFiniteGroups/"]
...
Germundsson"], None},
 ...
 " and ",
 ButtonBox["Charles Pooh",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Charles+Pooh"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Charles+Pooh"]
}], "Author",
...
CellTagsIndex->{
 "Copyright"->{
  Cell[46877, 879, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 73543, 1448}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34965, 592, 3866, 82, 70, "Output",
 CellID->116694133],
Cell[38834, 676, 142, 3, 70, "ManipulateCaption"],
Cell[38979, 681, 33, 0, 70, "DetailsSection"],
Cell[39015, 683, 297, 10, 70, "DetailNotes",
 CellID->449657193],
Cell[39315, 695, 44, 0, 70, "RelatedLinksSection"],
Cell[39362, 697, 625, 21, 70, "RelatedLinks",
 CellID->15722439],
Cell[39990, 720, 629, 21, 70, "RelatedLinks",
 CellID->117249309],
Cell[40622, 743, 4799, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[45424, 834, 45, 0, 70, "CitationSection"],
Cell[45472, 836, 786, 20, 70, "Citations"],
Cell[46261, 858, 613, 19, 70, "Author",
 CellID->263296305],
Cell[46877, 879, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature PRqIs1zhxfyFNw7NFlsnXWTW *)
