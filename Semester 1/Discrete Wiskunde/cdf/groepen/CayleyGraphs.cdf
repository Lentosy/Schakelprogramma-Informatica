...
NotebookDataLength[     82561,       1681]
NotebookOptionsPosition[     56269,       1111]
NotebookOutlinePosition[     82512,       1672]
CellTagsIndexPosition[     82401,       1666]
WindowTitle->Cayley Graphs
WindowFrame->Normal*)
...
Cell["Cayley Graphs", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`cycle$$ = True, $CellContext`i$$ = 
    34, $CellContext`j$$ = 27, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`i$$], 34, "permutation p"}, 1, 120, 1}, {{
       Hold[$CellContext`j$$], 27, "permutation q"}, 1, 120, 1}, {{
       Hold[$CellContext`cycle$$], True, "permutations in cycle form"}, {
      True, False}}}, Typeset`size$$ = {500., {198., 202.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`i$830$$ = 0, $CellContext`j$831$$ = 
    0, $CellContext`cycle$832$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`cycle$$ = True, $CellContext`i$$ = 
        34, $CellContext`j$$ = 27}, "ControllerVariables" :> {
        Hold[$CellContext`i$$, $CellContext`i$830$$, 0], 
        Hold[$CellContext`j$$, $CellContext`j$831$$, 0], 
        Hold[$CellContext`cycle$$, $CellContext`cycle$832$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> With[{$CellContext`cayley$ = {
           Part[
            Permutations[
             Range[5]], $CellContext`i$$], 
           Part[
            Permutations[
             Range[5]], $CellContext`j$$]}}, 
        GraphPlot3D[
         If[$CellContext`cycle$$, 
          Map[$CellContext`CanonicalPermutation[
             Part[#, 1]] -> $CellContext`CanonicalPermutation[
             Part[#, 2]]& , 
           $CellContext`cayleygraph[$CellContext`cayley$]], 
          Map[TraditionalForm[{
              Range[5], 
              Part[#, 1]}] -> TraditionalForm[{
              Range[5], 
              Part[#, 2]}]& , 
           $CellContext`cayleygraph[$CellContext`cayley$]]], Boxed -> False, 
         SphericalRegion -> True, PlotLabel -> If[$CellContext`cycle$$, 
           Style[
            Row[{
              StringJoin["p = ", 
               ToString[
                $CellContext`CanonicalPermutation[
                 Part[$CellContext`cayley$, 1]]]], 
              StringJoin["q = ", 
               ToString[
                $CellContext`CanonicalPermutation[
                 Part[$CellContext`cayley$, 2]]]]}, 
             Style["  |  ", 
              GrayLevel[0.5]]]], 
           Style[
            Row[{"p = ", 
              TraditionalForm[{
                Range[5], 
                Part[$CellContext`cayley$, 1]}], "q = ", 
              TraditionalForm[{
                Range[5], 
                Part[$CellContext`cayley$, 2]}]}, 
             Style["  |  ", 
              GrayLevel[0.5]]]]], ImageSize -> {500, 400}, ViewAngle -> 
         Pi/10]], 
      "Specifications" :> {{{$CellContext`i$$, 34, "permutation p"}, 1, 120, 
         1}, {{$CellContext`j$$, 27, "permutation q"}, 1, 120, 
         1}, {{$CellContext`cycle$$, True, "permutations in cycle form"}, {
         True, False}}}, "Options" :> {}, 
    ...
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`CanonicalPermutation[
          Pattern[$CellContext`aa, 
           Blank[List]]] := StringJoin[
          Map[$CellContext`ListToParens, 
           Sort[
            Reverse[
             Sort[
              Map[$CellContext`BestCycle, 
               $CellContext`CycleForm[$CellContext`aa]]]], Length[#] > 
            Length[#2]& ]]], $CellContext`ListToParens[
          Pattern[$CellContext`a, 
           Blank[List]]] := StringJoin["(", 
          ToString[
           FromDigits[$CellContext`a]], ")"], $CellContext`BestCycle[
          Pattern[$CellContext`a, 
           Blank[List]]] := First[
          Sort[
           Table[
            RotateRight[$CellContext`a, $CellContext`n], {$CellContext`n, 1, 
             Length[$CellContext`a]}]]], $CellContext`CycleForm[
          Pattern[$CellContext`kk, 
           Blank[List]]] := Union[
          Map[With[{$CellContext`gg = Take[#, Part[
                 Position[#, 
                  First[#]], 2, 1] - 1]}, 
            First[
             Sort[
              Table[
               ...
               RotateRight[$CellContext`gg, $CellContext`n], {$CellContext`n, 
                0, Length[$CellContext`gg] - 1}]]]]& , 
           Transpose[
            NestList[
            Part[$CellContext`kk, #]& , $CellContext`kk, 
             Length[$CellContext`kk] + 2]]]], $CellContext`cayleygraph[
          Pattern[$CellContext`aa, 
           Blank[List]]] := Union[
          Map[Sort, 
           Last[
            FixedPointList[Union[
              Flatten[{#, 
                Flatten[
                 Map[Last, 
                  $CellContext`Permutes[{#}, $CellContext`aa]], 1]}, 1]]& , 
             $CellContext`Permutes[{
               Range[
                Length[
                 
                 First[$CellContext`aa]]]}, $CellContext`aa]]]]], \
$CellContext`Permutes[
          Pattern[$CellContext`a, 
           Blank[List]], 
          ...
          Flatten[
           Table[{
             Part[$CellContext`a, $CellContext`aa], 
             Dot[
              Part[$CellContext`a, $CellContext`aa], 
              $CellContext`PermutationMatrix[
               Part[$CellContext`b, $CellContext`bb]]]}, {$CellContext`aa, 1, 
             Length[$CellContext`a]}, {$CellContext`bb, 1, 
             Length[$CellContext`b]}], 1]], $CellContext`PermutationMatrix[
          Pattern[$CellContext`p, 
           Blank[List]]] := Part[
          IdentityMatrix[
           Length[$CellContext`p]], $CellContext`p]}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`PermutationMatrix[
            Pattern[$CellContext`p, 
             Blank[List]]] := Part[
            IdentityMatrix[
             Length[$CellContext`p]], $CellContext`p]; 
         Null, $CellContext`Permutes[
            Pattern[$CellContext`a, 
             Blank[List]], 
            Pattern[$CellContext`b, 
             Blank[List]]] := Union[
            Flatten[
             Table[{
               ...
               Dot[
                Part[$CellContext`a, $CellContext`aa], 
                $CellContext`PermutationMatrix[
                 Part[$CellContext`b, $CellContext`bb]]]}, {$CellContext`aa, 
               1, 
               Length[$CellContext`a]}, {$CellContext`bb, 1, 
               Length[$CellContext`b]}], 1]]; Null, $CellContext`BestCycle[
            Pattern[$CellContext`a, 
             Blank[List]]] := First[
            Sort[
             Table[
              RotateRight[$CellContext`a, $CellContext`n], {$CellContext`n, 1, 
               Length[$CellContext`a]}]]]; Null, $CellContext`ListToParens[
            Pattern[$CellContext`a, 
             Blank[List]]] := StringJoin["(", 
            ToString[
             FromDigits[$CellContext`a]], ")"]; Null, $CellContext`CycleForm[
           Pattern[$CellContext`kk, 
            Blank[List]]] := Union[
           Map[With[{$CellContext`gg = Take[#, Part[
                  Position[#, 
            ...
            Transpose[
             NestList[
             Part[$CellContext`kk, #]& , $CellContext`kk, 
              Length[$CellContext`kk] + 
              2]]]], $CellContext`CanonicalPermutation[
            Pattern[$CellContext`aa, 
             Blank[List]]] := StringJoin[
            Map[$CellContext`ListToParens, 
             Sort[
              Reverse[
               Sort[
                Map[$CellContext`BestCycle, 
                 $CellContext`CycleForm[$CellContext`aa]]]], Length[#] > 
              Length[#2]& ]]]; Null, $CellContext`cayleygraph[
            Pattern[$CellContext`aa, 
             Blank[List]]] := Union[
            Map[Sort, 
             Last[
              FixedPointList[Union[
               ...
               $CellContext`Permutes[{
                 Range[
                  Length[
                   First[$CellContext`aa]]]}, $CellContext`aa]]]]]; Null}]]; 
...
Cell[TextData[{
 ...
 StyleBox["G",
  FontSlant->"Italic"],
 " with respect to a generating subset ",
 StyleBox["S",
  FontSlant->"Italic"],
 ". The vertices of the graph are the elements of ",
 StyleBox["G",
  FontSlant->"Italic"],
 ". (Mouse over a vertex to see the permutation.) Two vertices ",
 StyleBox["g",
  FontSlant->"Italic"],
 " and ",
 StyleBox["h",
  FontSlant->"Italic"],
 " are connected by an edge if there is a generator in ",
 StyleBox["S",
  FontSlant->"Italic"],
 " that multiplies ",
 StyleBox["g",
 ...
 StyleBox["h",
  FontSlant->"Italic"],
 " or vice versa. Here pairs of permutations {p, q} are used for S to \
construct polyhedra, symmetric graphs, and so on. "
}], "ManipulateCaption",
 CellID->1044312921],
...
Cell[TextData[{
 ButtonBox["Cayley Graph",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/CayleyGraph.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
CayleyGraphs&version=0025"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CayleyGraphs/CayleyGraphs-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Cayley Graphs",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CayleyGraphs/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CayleyGraphs/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/CayleyGraphs/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CayleyGraphs/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CayleyGraphs/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45685, 856, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[45946, 865, 2980, 67, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55447, 1086, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82114, 1655},
 {"Copyright", 82309, 1660}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1262, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35593, 600, 54, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35650, 603, 9192, 221, 70, "Output",
 CellID->180771639],
Cell[44845, 826, 837, 28, 70, "ManipulateCaption",
 CellID->1044312921],
Cell[45685, 856, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45946, 865, 2980, 67, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48929, 934, 44, 0, 70, "RelatedLinksSection"],
Cell[48976, 936, 563, 20, 70, "RelatedLinks",
 CellID->466351474],
Cell[49542, 958, 4775, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[54320, 1049, 45, 0, 70, "CitationSection"],
Cell[54368, 1051, 736, 20, 70, "Citations"],
Cell[55107, 1073, 337, 11, 70, "Author",
 CellID->52082847],
Cell[55447, 1086, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature OTafclLy9nSnTx7YjTO1Qy3e *)
