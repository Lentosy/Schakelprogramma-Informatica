...
NotebookDataLength[     84581,       1694]
NotebookOptionsPosition[     57526,       1114]
NotebookOutlinePosition[     83794,       1675]
CellTagsIndexPosition[     83683,       1669]
WindowTitle->Rotational Symmetries of Platonic Solids
WindowFrame->Normal*)
...
Cell["Rotational Symmetries of Platonic Solids", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`angle$$ = 
    0, $CellContext`axis$$ = $CellContext`edge, $CellContext`solid$$ = \
$CellContext`octahedron, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`angle$$], 0, 2 Pi}, {{
       Hold[$CellContext`solid$$], $CellContext`octahedron}, \
{$CellContext`tetrahedron, $CellContext`cube, $CellContext`octahedron, \
$CellContext`dodecahedron, $CellContext`icosahedron}}, {{
       Hold[$CellContext`axis$$], $CellContext`edge}, {$CellContext`vertex -> 
       "center to vertex", $CellContext`edge -> 
       "mid-edge to mid-edge", $CellContext`face -> "center to face"}}}, 
    Typeset`size$$ = {360., {178., 182.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`angle$17996$$ = 0, $CellContext`solid$17997$$ = 
    0, $CellContext`axis$17998$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`angle$$ = 
        0, $CellContext`axis$$ = $CellContext`edge, $CellContext`solid$$ = \
$CellContext`octahedron}, "ControllerVariables" :> {
        Hold[$CellContext`angle$$, $CellContext`angle$17996$$, 0], 
        Hold[$CellContext`solid$$, $CellContext`solid$17997$$, 0], 
        Hold[$CellContext`axis$$, $CellContext`axis$17998$$, False]}, 
      "OtherVariables" :> {
      ...
      "Body" :> ($CellContext`text1 = 
        If[$CellContext`solid$$ === $CellContext`tetrahedron, 
          "vertex-to-face", "vertex-to-vertex"]; $CellContext`text2 = 
        If[$CellContext`solid$$ === $CellContext`tetrahedron, 
          "face-to-vertex", "face-to-face"]; 
       Module[{$CellContext`a$, $CellContext`b$, $CellContext`c$, \
$CellContext`d$, $CellContext`e$, $CellContext`f$}, 
         Graphics3D[
          
          Switch[$CellContext`solid$$, $CellContext`tetrahedron, \
{$CellContext`a$, $CellContext`b$, $CellContext`c$, $CellContext`d$} = Part[
              PolyhedronData["Tetrahedron", "Faces"], 1]; $CellContext`v = 
            3 (($CellContext`a$ + $CellContext`b$ + $CellContext`d$)/3); 
           Switch[$CellContext`axis$$, $CellContext`vertex, {
              PolyhedronData["Tetrahedron", "Edges"], 
              Rotate[
               PolyhedronData[
               "Tetrahedron", 
                "Faces"], $CellContext`angle$$, $CellContext`a$], Thick, 
              Line[3 {-$CellContext`a$, $CellContext`a$}], 
              PointSize[0.02], 
              Point[$CellContext`a$]}, $CellContext`edge, {
              PolyhedronData["Tetrahedron", "Edges"], 
              Rotate[
               PolyhedronData[
               "Tetrahedron", 
                "Faces"], $CellContext`angle$$, ($CellContext`a$ + \
$CellContext`d$)/2], Thick, 
              Line[
              ...
              Rotate[
               PolyhedronData[
               "Tetrahedron", 
                "Faces"], $CellContext`angle$$, $CellContext`c$], Thick, 
              Line[3 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              Point[{$CellContext`c$, $CellContext`v}]}], $CellContext`cube, 
           Switch[$CellContext`axis$$, $CellContext`vertex, {
             PolyhedronData["Cube", "Edges"], 
             Rotate[
              PolyhedronData["Cube", "Faces"], $CellContext`angle$$, {1, 1, 
              1}], Thick, 
             Line[{-{1, 1, 1}, {1, 1, 1}}], 
             PointSize[0.02], 
             Point[0.5 {1, 1, 1}]}, $CellContext`edge, {
             PolyhedronData["Cube", "Edges"], 
             Rotate[
              PolyhedronData[
              "Cube", "Faces"], $CellContext`angle$$, (1/2) {1, 0, -1}], 
             Thick, 
             Line[2 {-{1, 0, -1}, {1, 0, -1}}], 
             PointSize[0.02], 
             Point[0.5 {-{1, 0, -1}, {1, 0, -1}}]}, $CellContext`face, {
             PolyhedronData["Cube", "Edges"], 
             Rotate[
              PolyhedronData["Cube", "Faces"], $CellContext`angle$$, {0, 0, 
              1}], Thick, 
             Line[5 {-{0, 0, 1}, {0, 0, 1}}], 
             PointSize[0.02], 
             Point[
             0.5 {0, 0, 
               1}]}], $CellContext`octahedron, {$CellContext`a$, \
...
$CellContext`c$)/3; Switch[$CellContext`axis$$, $CellContext`vertex, {
              PolyhedronData["Octahedron", "Edges"], 
              Rotate[
               PolyhedronData[
               "Octahedron", "Faces"], $CellContext`angle$$, $CellContext`a$],
               Thick, 
              Line[3 {-$CellContext`a$, $CellContext`a$}], 
              PointSize[0.02], 
              Point[$CellContext`a$]}, $CellContext`edge, {
              ...
              Rotate[
               PolyhedronData[
               "Octahedron", "Faces"], $CellContext`angle$$, $CellContext`u], 
              Thick, 
              Line[3 {-$CellContext`u, $CellContext`u}], 
              PointSize[0.02], 
              Point[{-$CellContext`u, $CellContext`u}]}, $CellContext`face, {
              PolyhedronData["Octahedron", "Edges"], 
              Rotate[
               PolyhedronData[
               "Octahedron", "Faces"], $CellContext`angle$$, $CellContext`v], 
              Thick, 
              Line[3 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              
              Point[$CellContext`v]}], $CellContext`dodecahedron, \
...
$CellContext`c$ + $CellContext`d$ + $CellContext`e$)/5; 
           Switch[$CellContext`axis$$, $CellContext`vertex, {
              ...
              Rotate[
               PolyhedronData[
               "Dodecahedron", 
                "Faces"], $CellContext`angle$$, $CellContext`u], Thick, 
              Line[3 {-$CellContext`u, $CellContext`u}], 
              PointSize[0.02], 
              Point[{-$CellContext`u, $CellContext`u}]}, $CellContext`face, {
              PolyhedronData["Dodecahedron", "Edges"], 
              Rotate[
               PolyhedronData[
               "Dodecahedron", 
                "Faces"], $CellContext`angle$$, $CellContext`v], Thick, 
              Line[3 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              
              Point[$CellContext`v]}], $CellContext`icosahedron, \
{$CellContext`a$, $CellContext`b$, $CellContext`c$} = Part[
              Part[
...
$CellContext`c$)/3; Switch[$CellContext`axis$$, $CellContext`vertex, {
              ...
              Rotate[
               PolyhedronData[
               "Icosahedron", "Faces"], $CellContext`angle$$, $CellContext`u],
               Thick, 
              ...
              Rotate[
               PolyhedronData[
               "Icosahedron", "Faces"], $CellContext`angle$$, $CellContext`v],
               Thick, 
              Line[4 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              Point[$CellContext`v]}]], Boxed -> False, PlotRange -> 
          Switch[$CellContext`solid$$, $CellContext`tetrahedron, 
            0.75, $CellContext`cube, 0.9, $CellContext`octahedron, 
            0.75, $CellContext`dodecahedron, 1.5, $CellContext`icosahedron, 
            1.1], ViewPoint -> 
          Switch[$CellContext`solid$$, $CellContext`tetrahedron, 
            Top, $CellContext`cube, {1.3, -2.4, 2}, $CellContext`octahedron, {
            1.3, -2.4, 2}, $CellContext`dodecahedron, {
            1.3, -2.4, 2}, $CellContext`icosahedron, {1.3, -2.4, 2}], 
          SphericalRegion -> True]]), 
      "Specifications" :> {{$CellContext`angle$$, 0, 2 
         Pi}, {{$CellContext`solid$$, $CellContext`octahedron}, \
{$CellContext`tetrahedron, $CellContext`cube, $CellContext`octahedron, \
$CellContext`dodecahedron, $CellContext`icosahedron}}, {{$CellContext`axis$$, \
$CellContext`edge}, {$CellContext`vertex -> 
          "center to vertex", $CellContext`edge -> 
          "mid-edge to mid-edge", $CellContext`face -> "center to face"}}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{405., {246., 251.}},
...
Cell[TextData[{
 "A symmetry of a figure moves a copy of the figure to coincide with its \
original position. Beside the rotations shown here, the other symmetries of \
the Platonic solids are reflections in various planes through the center. \
Symmetries are motions and form a group. If ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "\[SmallCircle]", "q"}], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 ButtonBox["Symmetry",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Symmetry.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
RotationalSymmetriesOfPlatonicSolids&version=0013"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/RotationalSymmetriesOfPlatonicSolids/\
RotationalSymmetriesOfPlatonicSolids-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
RotationalSymmetriesOfPlatonicSolids/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
RotationalSymmetriesOfPlatonicSolids/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[46849, 839, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[47110, 848, 1761, 40, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56704, 1089, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 83396, 1658},
 {"Copyright", 83591, 1663}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34999, 592, 10974, 222, 70, "Output",
 CellID->268106371],
Cell[45976, 816, 870, 21, 70, "ManipulateCaption"],
Cell[46849, 839, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47110, 848, 1761, 40, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48874, 890, 44, 0, 70, "RelatedLinksSection"],
Cell[48921, 892, 547, 19, 70, "RelatedLinks"],
Cell[49471, 913, 555, 20, 70, "RelatedLinks",
 CellID->15202218],
Cell[50029, 935, 550, 20, 70, "RelatedLinks",
 CellID->609355416],
Cell[50582, 957, 4847, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55432, 1048, 45, 0, 70, "CitationSection"],
Cell[55480, 1050, 897, 25, 70, "Citations"],
Cell[56380, 1077, 321, 10, 70, "Author"],
Cell[56704, 1089, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature RQaGigC6YvjR#xQxgfcqbhIt *)
