...
NotebookDataLength[     75048,       1490]
NotebookOptionsPosition[     47955,        907]
NotebookOutlinePosition[     74202,       1468]
CellTagsIndexPosition[     74091,       1462]
WindowTitle->Permutation Notations
WindowFrame->Normal*)
...
Cell["Permutation Notations", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 9, $CellContext`n$$ = 500, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 500, "permutation"}, 1, 
      Dynamic[
       Factorial[$CellContext`k$$]], 1}, {{
       Hold[$CellContext`k$$], 9, "length"}, 1, 9, 1}}, Typeset`size$$ = 
    Automatic, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n$196618$$ = 
    0, $CellContext`k$196619$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 9, $CellContext`n$$ = 500}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$196618$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$196619$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[$CellContext`n$$ > Factorial[$CellContext`k$$], $CellContext`n$$ = 
         Factorial[$CellContext`k$$]]; Column[{
          Style[
           TraditionalForm[{
             Range[$CellContext`k$$], 
             Combinatorica`UnrankPermutation[$CellContext`n$$, 
              Range[$CellContext`k$$]]}], "Label", FontSize -> 16], " ", 
          Style[
           StringJoin[
               ...
               Sort[
                Map[$CellContext`BestCycle, 
                 Combinatorica`ToCycles[
                  Combinatorica`UnrankPermutation[$CellContext`n$$, 
                   Range[$CellContext`k$$]]]]]], Length[#] > Length[#2]& ]]], 
           "Label", FontSize -> 16], " ", 
          GraphPlot[
           Apply[Rule, 
            Transpose[{
              Range[$CellContext`k$$], 
              Combinatorica`UnrankPermutation[$CellContext`n$$, 
               Range[$CellContext`k$$]]}], {1}], ImageSize -> {200, 200}, 
           VertexLabeling -> True, DirectedEdges -> True]}]), 
      "Specifications" :> {{{$CellContext`n$$, 500, "permutation"}, 1, 
         Dynamic[
          Factorial[$CellContext`k$$]], 1, Appearance -> 
         "Labeled"}, {{$CellContext`k$$, 9, "length"}, 1, 9, 1, Appearance -> 
         "Labeled"}}, "Options" :> {SynchronousInitialization -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{335., {64., 69.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>((Quiet[
        Get["Combinatorica`"]]; $CellContext`BestCycle[
         Pattern[$CellContext`a$, 
          Blank[List]]] := First[
         Sort[
          Table[
           
           RotateRight[$CellContext`a$, $CellContext`n$$], {$CellContext`n$$, 
            1, 
            Length[$CellContext`a$]}]]]; $CellContext`ListToParens[
         Pattern[$CellContext`a, 
          Blank[List]]] := StringJoin["(", 
         ToString[
          FromDigits[$CellContext`a]], ")"]; Null); Typeset`initDone$$ = True),
...
Cell[TextData[{
 "The number of ways to arrange seven objects in a row is ",
 Cell[BoxData[
  FormBox[
   RowBox[{"7", "=", 
    RowBox[{
     RowBox[{
     "7", "\[Times]", "6", "\[Times]", "5", "\[Times]", "4", "\[Times]", "3", 
      "\[Times]", "2", "\[Times]", "1"}], "=", "5040"}]}], TraditionalForm]], 
  "InlineMath"],
 ". The arrangements are called permutations. Combinatorialists use two \
notational systems for permutations. "
}], "ManipulateCaption",
 CellID->194059933],

Cell["\<\
The first notation has positions on top and numbers of the rearranged objects \
on the bottom. It can be read as a mapping of a finite set of numbers, where \
the numbers on top get mapped to those below. \
\>", "ManipulateCaption",
 CellID->94746626],

Cell["\<\
The second notation applies that mapping repeatedly to any starting number \
until there is a repetition. Then a new number is chosen to start the next \
cycle, and so on. A permutation can be shown as a directed graph. \
\>", "ManipulateCaption",
 CellID->125469871],
...
PermutationNotations&version=0017"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PermutationNotations/\
PermutationNotations-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 ...
 ButtonBox["http://demonstrations.wolfram.com/PermutationNotations/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PermutationNotations/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PermutationNotations/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39590, 704, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39851, 713, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[47133, 882, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 73806, 1451},
 {"Copyright", 74000, 1456}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34961, 592, 3595, 81, 70, "Output",
 CellID->377413308],
Cell[38559, 675, 484, 13, 70, "ManipulateCaption",
 CellID->194059933],
Cell[39046, 690, 261, 5, 70, "ManipulateCaption",
 CellID->94746626],
Cell[39310, 697, 277, 5, 70, "ManipulateCaption",
 CellID->125469871],
Cell[39590, 704, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39851, 713, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40545, 730, 44, 0, 70, "RelatedLinksSection"],
Cell[40592, 732, 560, 20, 70, "RelatedLinks",
 CellID->4990307],
Cell[41155, 754, 4799, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[45957, 845, 45, 0, 70, "CitationSection"],
Cell[46005, 847, 784, 20, 70, "Citations"],
Cell[46792, 869, 338, 11, 70, "Author",
 CellID->226799811],
Cell[47133, 882, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature 7Sa#21WkirsuKwQIjQ9LeX4z *)
