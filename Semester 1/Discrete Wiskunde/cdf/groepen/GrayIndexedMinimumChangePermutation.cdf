...
NotebookDataLength[     84992,       1728]
NotebookOptionsPosition[     57926,       1146]
NotebookOutlinePosition[     84192,       1707]
CellTagsIndexPosition[     84081,       1701]
WindowTitle->Gray Indexed Minimum Change Permutation
WindowFrame->Normal*)
...
Cell["Gray Indexed Minimum Change Permutation", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 3, $CellContext`s$$ = 0, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`s$$], 0, "offset"}, 0, 
      Dynamic[-1 + Factorial[$CellContext`k$$]]}, {{
       Hold[$CellContext`k$$], 3, "size of set"}, 3, 11, 1}}, 
    Typeset`size$$ = {350., {173., 177.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`s$87791$$ = 0, $CellContext`k$87792$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 3, $CellContext`s$$ = 0}, 
      "ControllerVariables" :> {
        Hold[$CellContext`s$$, $CellContext`s$87791$$, 0], 
        Hold[$CellContext`k$$, $CellContext`k$87792$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> ($CellContext`s$$ = 
        Min[$CellContext`s$$, -1 + Factorial[$CellContext`k$$]]; 
       With[{$CellContext`m$ = $CellContext`k$$}, 
         (Graphics[
          Flatten[{Gray, 
            Disk[{1/2 + $CellContext`m$/2, 0}, 1/2 + $CellContext`m$/2], 
            $CellContext`minexchangepermani[
             $CellContext`minchangeperm[
              IntegerPart[#], $CellContext`m$], 
             $CellContext`minchangeperm[
              IntegerPart[# + 1], $CellContext`m$], 
             FractionalPart[#], $CellContext`m$]}], 
          PlotRange -> {{
            0, $CellContext`m$ + 1}, {(-1)/2 - $CellContext`m$/2, 
             1/2 + $CellContext`m$/2}}, PlotLabel -> Style[
            Grid[{{"mixed base", 
               Reverse[
                Rest[
                 Range[$CellContext`m$]]]}, {
               Row[{"grayed index of ", 
                 Superscript[
                  Style["n", Italic], "th"], " permutation"}], 
               $CellContext`tograycode[
                IntegerPart[#], 
                Reverse[
                 Rest[
                  Range[$CellContext`m$]]]]}, {
              "grayed index of next permutation", 
               $CellContext`tograycode[
                IntegerPart[# + 1], 
                Reverse[
                 Rest[
                  Range[$CellContext`m$]]]]}}], "Label"], 
          ImageSize -> {350, 350}]& )[
          Mod[$CellContext`s$$, -1 + Factorial[$CellContext`m$]]]]), 
      "Specifications" :> {{{$CellContext`s$$, 0, "offset"}, 0, 
         Dynamic[-1 + Factorial[$CellContext`k$$]]}, {{$CellContext`k$$, 3, 
          "size of set"}, 3, 11, 1}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{395., {231., 236.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`minexchangepermani[
          ...
          Pattern[$CellContext`m, 
           Blank[]]] := With[{$CellContext`dd = Flatten[
             Position[$CellContext`v1 - $CellContext`v2, 0]]}, {
           With[{$CellContext`cc = Complement[
               Range[
                Length[$CellContext`v1]], $CellContext`dd]}, 
            If[$CellContext`cc == {}, {}, 
             ($CellContext`ifchang[
              Part[$CellContext`v1, #], 
              
              Part[$CellContext`v2, #], #, $CellContext`phase, \
$CellContext`m]& )[$CellContext`cc]]], 
           Map[$CellContext`ifsame[
             
             Part[$CellContext`v1, #], {#, 
              0}, $CellContext`m]& , $CellContext`dd]}], $CellContext`ifchang[
          ...
          Pattern[$CellContext`m, 
           Blank[]]] := 
        If[$CellContext`c1 === Reverse[$CellContext`c2], {White, 
           Disk[{
             Mean[$CellContext`p], 0}, 1/2 + 
            Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]]], Gray, 
           Disk[{
             Mean[$CellContext`p], 0}, (-1)/2 + 
            Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]]], 
           Hue[Part[$CellContext`c1, 1]/$CellContext`m, 1/2, 1], 
           Disk[{
               Cos[Pi - $CellContext`phase Pi], 
               Sin[Pi - $CellContext`phase Pi]} 
             Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]] + {
              Mean[$CellContext`p], 0}, 1/2], Black, 
           Text[
            Part[$CellContext`c1, 1], {
               Cos[Pi - $CellContext`phase Pi], 
               Sin[Pi - $CellContext`phase Pi]} 
             Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]] + {
              Mean[$CellContext`p], 0}], 
           Hue[Part[$CellContext`c2, 1]/$CellContext`m, 1/2, 1], 
           Disk[{
               Cos[(-$CellContext`phase) Pi], 
               Sin[(-$CellContext`phase) Pi]} 
             Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]] + {
              Mean[$CellContext`p], 0}, 1/2], Black, 
           Text[
            Part[$CellContext`c2, 1], {
               ...
               Sin[(-$CellContext`phase) Pi]} 
             Abs[Mean[$CellContext`p] - Part[$CellContext`p, 1]] + {
              Mean[$CellContext`p], 0}]}, $Failed], $CellContext`ifsame[
          ...
          Pattern[$CellContext`m, 
           Blank[]]] := {
          Hue[$CellContext`c/$CellContext`m, 1/2, 1], 
          Disk[$CellContext`p, 1/2], Black, 
          Text[$CellContext`c, $CellContext`p]}, $CellContext`minchangeperm[
          Pattern[$CellContext`i, 
           Blank[]], 
          Pattern[$CellContext`n, 
           Blank[]]] := $CellContext`nthp[
          Dot[
           $CellContext`tograycode[$CellContext`i, 
            Reverse[
             Rest[
              Range[$CellContext`n]]]], 
           Reverse[
            Rest[
             FoldList[Times, 1, 
              Most[
               Range[$CellContext`n]]]]]], $CellContext`n], $CellContext`nthp[
          Pattern[$CellContext`n1$, 
           Blank[]], 
          Pattern[$CellContext`l$, 
           Blank[]]] := 
        Block[{FE`k$$454, $CellContext`n = $CellContext`n1$, FE`s$$454 = 
           Range[$CellContext`l$]}, 
          Map[($CellContext`n = Mod[$CellContext`n, 
              Factorial[# + 1]]; 
           FE`k$$454 = Part[FE`s$$454, Quotient[$CellContext`n, 
                Factorial[#]] + 1]; 
           FE`s$$454 = Complement[FE`s$$454, {FE`k$$454}]; FE`k$$454)& , 
           Reverse[
            Range[0, $CellContext`l$ - 1]]]], 
        Attributes[$CellContext`n1$] = {Temporary}, 
        Attributes[$CellContext`l$] = {Temporary}, FE`k$$454 = 3, FE`s$$454 = 
        0, $CellContext`tograycode := Compile[{{$CellContext`i, 
            Blank[Integer]}, {$CellContext`descript, 
            Blank[Integer], 1}}, 
          With[{$CellContext`h = Length[$CellContext`descript]}, 
           Table[
            With[{$CellContext`u = Floor[
                 Mod[$CellContext`i/Apply[Times, 
                   
                   Take[$CellContext`descript, $CellContext`p - \
$CellContext`h]], 2 Part[$CellContext`descript, $CellContext`p]]] + 1}, 
             Thread[
              
              If[$CellContext`u > Part[$CellContext`descript, $CellContext`p],
                2 Part[$CellContext`descript, $CellContext`p] - \
$CellContext`u, $CellContext`u - 1]]], {$CellContext`p, $CellContext`h}]]], 
        Attributes[PlotRange] = {ReadProtected}, 
        Attributes[Superscript] = {NHoldRest, ReadProtected}}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`nthp[
           Pattern[$CellContext`n1, 
            Blank[]], 
           Pattern[$CellContext`l, 
            Blank[]]] := 
         Block[{$CellContext`k, $CellContext`n = $CellContext`n1, \
$CellContext`s = Range[$CellContext`l]}, 
           Map[($CellContext`n = Mod[$CellContext`n, 
               Factorial[# + 1]]; $CellContext`k = 
             Part[$CellContext`s, Quotient[$CellContext`n, 
                 Factorial[#]] + 1]; $CellContext`s = 
             Complement[$CellContext`s, {$CellContext`k}]; $CellContext`k)& , 
            Reverse[
             Range[0, $CellContext`l - 1]]]], $CellContext`tograycode := 
         Compile[{{$CellContext`i, 
             Blank[Integer]}, {$CellContext`descript, 
             Blank[Integer], 1}}, 
           With[{$CellContext`h = Length[$CellContext`descript]}, 
            Table[
...
$CellContext`h]], 2 Part[$CellContext`descript, $CellContext`p]]] + 1}, 
              Thread[
               ...
               If[$CellContext`u > 
                Part[$CellContext`descript, $CellContext`p], 
                2 Part[$CellContext`descript, $CellContext`p] - \
$CellContext`u, $CellContext`u - 
                1]]], {$CellContext`p, $CellContext`h}]]], \
$CellContext`minchangeperm[
           Pattern[$CellContext`i, 
            Blank[]], 
           Pattern[$CellContext`n, 
             ...
             Rest[
              FoldList[Times, 1, 
               Most[
                ...
                Range[$CellContext`n]]]]]], $CellContext`n], \
$CellContext`minexchangepermani[
           Pattern[$CellContext`v1, 
            Blank[]], 
           Pattern[$CellContext`v2, 
...
$CellContext`m]& )[$CellContext`cc]]], 
            Map[$CellContext`ifsame[
              ...
              Part[$CellContext`v1, #], {#, 
               0}, $CellContext`m]& , $CellContext`dd]}], $CellContext`ifsame[
           Pattern[$CellContext`c, 
            Blank[]], 
           Pattern[$CellContext`p, 
            Blank[]], 
           ...
           Hue[$CellContext`c/$CellContext`m, 1/2, 1], 
           Disk[$CellContext`p, 1/2], Black, 
           Text[$CellContext`c, $CellContext`p]}, $CellContext`ifchang[
           Pattern[$CellContext`c1, 
            Blank[]], 
           Pattern[$CellContext`c2, 
            Blank[]], 
...
Cell["\<\
In a minimum change enumeration of permutations, all neighboring permutations \
differ by exactly one transposition of two elements. Minimum change \
permutations can be constructed from Gray coded mixed base indices.\
\>", "ManipulateCaption",
 CellID->1606225743],
...
Cell[TextData[{
 ButtonBox["Permutation",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Permutation.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
GrayIndexedMinimumChangePermutation&version=0014"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/GrayIndexedMinimumChangePermutation/\
GrayIndexedMinimumChangePermutation-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Gray Indexed Minimum Change Permutation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
GrayIndexedMinimumChangePermutation/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/GrayIndexedMinimumChangePermutation/"],
 "\"",
 " from ",
...
GrayIndexedMinimumChangePermutation/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
GrayIndexedMinimumChangePermutation/"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[48829, 916, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[49090, 925, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57104, 1121, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 83795, 1690},
 {"Copyright", 83989, 1695}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[603, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34934, 590, 80, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35017, 593, 13531, 314, 70, "Output",
 CellID->715912030],
Cell[48551, 909, 275, 5, 70, "ManipulateCaption",
 CellID->1606225743],
Cell[48829, 916, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49090, 925, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[49784, 942, 44, 0, 70, "RelatedLinksSection"],
Cell[49831, 944, 562, 20, 70, "RelatedLinks",
 CellID->917457820],
Cell[50396, 966, 557, 20, 70, "RelatedLinks",
 CellID->331695254],
Cell[50956, 988, 4844, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55803, 1079, 45, 0, 70, "CitationSection"],
Cell[55851, 1081, 891, 25, 70, "Citations"],
Cell[56745, 1108, 356, 11, 70, "Author",
 CellID->202572579],
Cell[57104, 1121, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature ESqu55eONk8fluQT9f@IyLUj *)
