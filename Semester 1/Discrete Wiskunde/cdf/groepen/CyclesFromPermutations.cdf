...
NotebookDataLength[     79449,       1615]
NotebookOptionsPosition[     52213,       1029]
NotebookOutlinePosition[     78465,       1590]
CellTagsIndexPosition[     78354,       1584]
WindowTitle->Cycles from Permutations
WindowFrame->Normal*)
...
Cell["Cycles from Permutations", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`permLength$$ = 10, $CellContext`sr$$ = 
    52508, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`permLength$$], 10, "permutation length"}, 2, 40, 
      1}, {{
       Hold[$CellContext`sr$$], 52508, 
       "new random permutation of the same length"}, 1, 123456, 1}}, 
    Typeset`size$$ = {450., {246., 115.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`permLength$47046$$ = 0, $CellContext`sr$47047$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`permLength$$ = 10, $CellContext`sr$$ = 
        52508}, "ControllerVariables" :> {
        Hold[$CellContext`permLength$$, $CellContext`permLength$47046$$, 0], 
        Hold[$CellContext`sr$$, $CellContext`sr$47047$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`perm = (SeedRandom[$CellContext`sr$$]; RandomSample[
            
            Range[$CellContext`permLength$$], $CellContext`permLength$$]), \
$CellContext`c}, $CellContext`c = $CellContext`cycles[$CellContext`perm]; 
        Labeled[
          GraphPlot[
           $CellContext`cyclesToGraph[$CellContext`c], DirectedEdges -> True, 
           VertexLabeling -> True, ImageSize -> {450, 225}, AspectRatio -> 
           225/450], 
          Pane[
           Text[
            Grid[{{"permutation", $CellContext`perm}, {"cycles", 
               $CellContext`cycleNotation[$CellContext`c]}}, Background -> {{
                ColorData["Legacy"]["DeepNaplesYellow"], 
                Lighter[
                 ColorData["Legacy"]["DeepNaplesYellow"], 0.3]}, None}, 
             ItemSize -> {{8, 26}, 1}, Dividers -> All, BaseStyle -> {14}]], {
           450, 130}]]], 
      "Specifications" :> {{{$CellContext`permLength$$, 10, 
          "permutation length"}, 2, 40, 1, Appearance -> 
         "Labeled"}, {{$CellContext`sr$$, 52508, 
          "new random permutation of the same length"}, 1, 123456, 1}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{495., {236., 241.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`cycles[
          Pattern[$CellContext`perm, 
           Blank[]]] := First[
          Last[
           Reap[
            NestWhile[Complement[#, 
              Sow[
               Most[
                NestWhileList[Part[$CellContext`perm, #]& , 
                 First[#], UnsameQ, 
                 All]]]]& , $CellContext`perm, # =!= {}& ]]]], \
$CellContext`cyclesToGraph[
          Pattern[$CellContext`cycleStructure, 
           Blank[List]]] := Flatten[
          Apply[Rule, 
           Map[Partition[#, 2, 1, {1, 1}]& , $CellContext`cycleStructure], {
           2}]], $CellContext`cycleNotation[
          Pattern[$CellContext`cycle, 
           Blank[]]] := StringTake[
          StringReplace[
           ToString[$CellContext`cycle], {
           "{" -> "(", RegularExpression["},?"] -> ")"}], {2, -2}]}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`cycles[
           Pattern[$CellContext`perm, 
            Blank[]]] := First[
           Last[
            Reap[
...
Cell[TextData[{
 "A permutation is a list in which each element occurs only once. If the \
members of the permutation have values ",
 Cell[BoxData[
  FormBox[
 ...
 " is the length of the permutation, then you can think of a permutation as \
an \"onto\" (\"surjective\") function of the set ",
 Cell[BoxData[
  FormBox[
   RowBox[{"{", 
    RowBox[{"1", ",", "2", ",", "\[Ellipsis]", ",", "n"}], "}"}], 
   TraditionalForm]], "InlineMath"],
 " to itself. If you successively apply this function to any member of the \
set, you obtain its \"cycle\" or \"orbit\". This Demonstration shows how you \
can write a permutation as a list of these cycles and how these cycles can be \
...
Cell[TextData[{
 "This Demonstration uses its own code and the ",
 StyleBox["Sow", "MR"],
 "/",
 StyleBox["Reap", "MR"],
 " construct as well as ",
 StyleBox["NestWhile", "MR"],
 " to find the cycles of a permutation. The ",
 StyleBox["Combinatorica",
  FontSlant->"Italic"],
 " package contains alternative code for finding cycles that has a more \
\"procedural\" style. "
}], "DetailNotes",
 CellID->1332537717],
...
Cell[TextData[{
 ButtonBox["Cycle Graph",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/CycleGraph.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Cycles in Random Sample Permutations",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CyclesInRandomSamplePermutations/"]\
, None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Sample",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Sample.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
CyclesFromPermutations&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CyclesFromPermutations/\
CyclesFromPermutations-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Cycles from Permutations",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CyclesFromPermutations/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CyclesFromPermutations/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/CyclesFromPermutations/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CyclesFromPermutations/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CyclesFromPermutations/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40582, 721, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40843, 730, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[51391, 1004, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 78067, 1573},
 {"Copyright", 78262, 1578}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34967, 592, 4726, 104, 70, "Output",
 CellID->180252204],
Cell[39696, 698, 883, 21, 70, "ManipulateCaption"],
Cell[40582, 721, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40843, 730, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42771, 776, 33, 0, 70, "DetailsSection"],
Cell[42807, 778, 413, 13, 70, "DetailNotes",
 CellID->1332537717],
Cell[43223, 793, 44, 0, 70, "RelatedLinksSection"],
Cell[43270, 795, 560, 20, 70, "RelatedLinks",
 CellID->36731193],
Cell[43833, 817, 443, 14, 70, "RelatedLinks",
 CellID->138657039],
Cell[44279, 833, 562, 20, 70, "RelatedLinks",
 CellID->136111733],
Cell[44844, 855, 552, 20, 70, "RelatedLinks",
 CellID->283729817],
Cell[45399, 877, 4805, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[50207, 968, 45, 0, 70, "CitationSection"],
Cell[50255, 970, 797, 20, 70, "Citations"],
Cell[51055, 992, 333, 10, 70, "Author"],
Cell[51391, 1004, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature oTayeZSejzvDMxQh5ouS5AgG *)
