...
NotebookDataLength[     98035,       2048]
NotebookOptionsPosition[     70949,       1467]
NotebookOutlinePosition[     97228,       2028]
CellTagsIndexPosition[     97117,       2022]
WindowTitle->Rotational Symmetries of Colored Platonic Solids 
WindowFrame->Normal*)
...
Cell["Rotational Symmetries of Colored Platonic Solids ", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`angle$$ = 0, $CellContext`axis$$ = 
    3, $CellContext`coloring$$ = 1, $CellContext`solid$$ = 2, Typeset`show$$ =
     True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`angle$$], 0, 2 Pi}, {{
       Hold[$CellContext`coloring$$], 1}, {
      1 -> "every face different", 2 -> "random 4-coloring"}}, {{
       Hold[$CellContext`solid$$], 2}, {
      1 -> "tetrahedron", 2 -> "cube", 3 -> "octahedron", 4 -> "dodecahedron",
        5 -> "icosahedron"}}, {{
       Hold[$CellContext`axis$$], 3}, {
      1 -> "center to vertex", 2 -> "mid-edge to mid-edge", 3 -> 
       "center to face"}}}, Typeset`size$$ = {360., {178., 182.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`angle$118176$$ = 0, $CellContext`coloring$118177$$ = 
    False, $CellContext`solid$118178$$ = False, $CellContext`axis$118179$$ = 
    False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`angle$$ = 0, $CellContext`axis$$ = 
        3, $CellContext`coloring$$ = 1, $CellContext`solid$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`angle$$, $CellContext`angle$118176$$, 0], 
        Hold[$CellContext`coloring$$, $CellContext`coloring$118177$$, False], 
        Hold[$CellContext`solid$$, $CellContext`solid$118178$$, False], 
        Hold[$CellContext`axis$$, $CellContext`axis$118179$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, 
      "Body" :> ($CellContext`text1 = 
        If[$CellContext`solid$$ === 1, "vertex-to-face", 
          "vertex-to-vertex"]; $CellContext`text2 = 
        If[$CellContext`solid$$ === 1, "face-to-vertex", "face-to-face"]; 
       Module[{$CellContext`a$, $CellContext`b$, $CellContext`c$, \
$CellContext`d$, $CellContext`e$, $CellContext`f$}, 
         Graphics3D[
          
          Switch[$CellContext`solid$$, 
           1, {$CellContext`a$, $CellContext`b$, $CellContext`c$, \
$CellContext`d$} = Part[
              PolyhedronData["Tetrahedron", "Faces"], 1]; $CellContext`v = 
            3 (($CellContext`a$ + $CellContext`b$ + $CellContext`d$)/3); 
           Switch[$CellContext`axis$$, 1, {
              PolyhedronData["Tetrahedron", "Edges"], 
              Rotate[
               ReplaceAll[
                Normal[
                 PolyhedronData["Tetrahedron", "Faces"]], Polygon[
                  Pattern[$CellContext`x$, 
                   Blank[]]] :> {
                  Glow[
                   Switch[$CellContext`coloring$$, 2, 
                    Part[$CellContext`randomfourcolors, 
                    Part[
                    Position[
                    Normal[
                    PolyhedronData["Tetrahedron", "Faces"]], 
                    Polygon[$CellContext`x$]], 1, 2]], 1, 
                    Part[$CellContext`colors, 
                    Part[
                    Position[
                    Normal[
                    PolyhedronData["Tetrahedron", "Faces"]], 
                    Polygon[$CellContext`x$]], 1, 2]]]], 
                  
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`a$], Thick, 
              Line[3 {-$CellContext`a$, $CellContext`a$}], 
              PointSize[0.02], 
              Point[$CellContext`a$]}, 2, {
              PolyhedronData["Tetrahedron", "Edges"], 
              Rotate[
               ReplaceAll[
                Normal[
                 PolyhedronData["Tetrahedron", "Faces"]], Polygon[
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
($CellContext`a$ + $CellContext`d$)/2], Thick, 
              Line[
              3 {(-($CellContext`a$ + $CellContext`d$))/
                 2, ($CellContext`a$ + $CellContext`d$)/2}], 
              PointSize[0.02], 
              
              Point[{(-($CellContext`a$ + $CellContext`d$))/
                2, ($CellContext`a$ + $CellContext`d$)/2}]}, 3, {
              PolyhedronData["Tetrahedron", "Edges"], 
              Rotate[
               ReplaceAll[
                Normal[
                 PolyhedronData["Tetrahedron", "Faces"]], Polygon[
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`c$], Thick, 
              Line[3 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              Point[{$CellContext`c$, $CellContext`v}]}], 2, 
           Switch[$CellContext`axis$$, 1, {
             PolyhedronData["Cube", "Edges"], 
             Rotate[
              ReplaceAll[
               Normal[
                PolyhedronData["Cube", "Faces"]], Polygon[
                 Pattern[$CellContext`x$, 
                  Blank[]]] :> {
                 Glow[
                  Switch[$CellContext`coloring$$, 2, 
                   ...
                   Part[$CellContext`colors, 
                    ...
                    PolyhedronData["Cube", "Faces"]], 
                    Polygon[$CellContext`x$]], 1, 2]]]], 
                 Polygon[$CellContext`x$]}], $CellContext`angle$$, {1, 1, 1}],
              Thick, 
             Line[{-{1, 1, 1}, {1, 1, 1}}], 
             PointSize[0.02], 
             Point[0.5 {1, 1, 1}]}, 2, {
                 ...
                 Glow[
                  Switch[$CellContext`coloring$$, 2, 
                   ...
                   Part[$CellContext`colors, 
                    ...
                    PolyhedronData["Cube", "Faces"]], 
                    Polygon[$CellContext`x$]], 1, 2]]]], 
                 Polygon[$CellContext`x$]}], $CellContext`angle$$, (1/2) {1, 
               0, -1}], Thick, 
             Line[2 {-{1, 0, -1}, {1, 0, -1}}], 
             PointSize[0.02], 
             Point[0.5 {-{1, 0, -1}, {1, 0, -1}}]}, 3, {
             PolyhedronData["Cube", "Edges"], 
             Rotate[
              ReplaceAll[
               Normal[
                 ...
                 Glow[
                  Switch[$CellContext`coloring$$, 2, 
                   ...
                   Part[$CellContext`colors, 
                    ...
                    PolyhedronData["Cube", "Faces"]], 
                    Polygon[$CellContext`x$]], 1, 2]]]], 
                 Polygon[$CellContext`x$]}], $CellContext`angle$$, {0, 0, 1}],
              Thick, 
             Line[5 {-{0, 0, 1}, {0, 0, 1}}], 
             PointSize[0.02], 
             Point[0.5 {0, 0, 1}]}], 
           3, {$CellContext`a$, $CellContext`b$, $CellContext`c$, \
$CellContext`d$, $CellContext`e$, $CellContext`f$} = Part[
              PolyhedronData["Octahedron", "Faces"], 
              1]; $CellContext`u = ($CellContext`a$ + $CellContext`b$)/
             2; $CellContext`v = ($CellContext`a$ + $CellContext`b$ + \
$CellContext`c$)/3; Switch[$CellContext`axis$$, 1, {
              PolyhedronData["Octahedron", "Edges"], 
              Rotate[
               ReplaceAll[
                Normal[
               ...
               ReplaceAll[
                Normal[
                 PolyhedronData["Octahedron", "Faces"]], Polygon[
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`u], Thick, 
              Line[3 {-$CellContext`u, $CellContext`u}], 
              PointSize[0.02], 
              Point[{-$CellContext`u, $CellContext`u}]}, 3, {
              PolyhedronData["Octahedron", "Edges"], 
              Rotate[
               ReplaceAll[
                Normal[
...
$CellContext`d$, $CellContext`e$} = N[
              Part[
               Part[
                PolyhedronData["Dodecahedron", "Faces"], 1], {15, 10, 9, 14, 
               1}]]; $CellContext`u = ($CellContext`a$ + $CellContext`b$)/
             2; $CellContext`v = ($CellContext`a$ + $CellContext`b$ + \
$CellContext`c$ + $CellContext`d$ + $CellContext`e$)/5; 
           Switch[$CellContext`axis$$, 1, {
              N[
               PolyhedronData["Dodecahedron", "Edges"]], 
              Rotate[
               ReplaceAll[
                Normal[
                 N[
...
$CellContext`v], Thick, 
              ...
              PointSize[0.02], 
              Point[$CellContext`v]}], 
           5, {$CellContext`a$, $CellContext`b$, $CellContext`c$} = N[
              Part[
               Part[
                PolyhedronData["Icosahedron", "Faces"], 1], {2, 12, 
               8}]]; $CellContext`u = ($CellContext`a$ + $CellContext`b$)/
             2; $CellContext`v = ($CellContext`a$ + $CellContext`b$ + \
$CellContext`c$)/3; Switch[$CellContext`axis$$, 1, {
              N[
              ...
              Rotate[
               ReplaceAll[
                Normal[
                 N[
                  PolyhedronData["Icosahedron", "Faces"]]], Polygon[
                  Pattern[$CellContext`x$, 
                   Blank[]]] :> {
                  Glow[
                   Switch[$CellContext`coloring$$, 2, 
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`a$], Thick, 
              Line[4 {-$CellContext`a$, $CellContext`a$}], 
              PointSize[0.02], 
              Point[$CellContext`a$]}, 2, {
              N[
               PolyhedronData["Icosahedron", "Edges"]], 
               ...
               ReplaceAll[
                Normal[
                 N[
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`u], Thick, 
              Line[4 {-$CellContext`u, $CellContext`u}], 
              PointSize[0.02], 
              Point[{-$CellContext`u, $CellContext`u}]}, 3, {
              N[
               PolyhedronData["Icosahedron", "Edges"]], 
               ...
               ReplaceAll[
                Normal[
                 N[
                  ...
                  Polygon[$CellContext`x$]}], $CellContext`angle$$, \
$CellContext`v], Thick, 
              Line[4 {-$CellContext`v, $CellContext`v}], 
              PointSize[0.02], 
              Point[$CellContext`v]}]], Boxed -> False, Lighting -> None, 
          PlotRange -> 
          Switch[$CellContext`solid$$, 1, 0.75, 2, 0.9, 3, 0.75, 4, 1.5, 5, 
            1.1], ViewPoint -> 
          Switch[$CellContext`solid$$, 1, Top, 2, {1.3, -2.4, 2}, 3, {
            1.3, -2.4, 2}, 4, {1.3, -2.4, 2}, 5, {1.3, -2.4, 2}], 
          SphericalRegion -> True]]), 
      "Specifications" :> {{$CellContext`angle$$, 0, 2 
         Pi}, {{$CellContext`coloring$$, 1}, {
         1 -> "every face different", 2 -> 
          "random 4-coloring"}}, {{$CellContext`solid$$, 2}, {
         1 -> "tetrahedron", 2 -> "cube", 3 -> "octahedron", 4 -> 
          "dodecahedron", 5 -> "icosahedron"}}, {{$CellContext`axis$$, 3}, {
         1 -> "center to vertex", 2 -> "mid-edge to mid-edge", 3 -> 
          "center to face"}}}, 
      "Options" :> {
       TrackedSymbols :> {$CellContext`angle$$, $CellContext`coloring$$, \
$CellContext`solid$$, $CellContext`axis$$}, AutorunSequencing -> {1, 3, 4}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{405., {258., 263.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`text1 = 
        "vertex-to-vertex", $CellContext`text2 = 
        "face-to-face", $CellContext`v = {-0.6759734692155547, 0., 
         0.8848607589497514}, $CellContext`randomfourcolors = {
          RGBColor[1, 1, 0], 
          RGBColor[1, 1, 0], 
          RGBColor[0, 0, 1], 
          RGBColor[0, 0, 1], 
          ...
          RGBColor[0, 0, 1], 
          RGBColor[0, 1, 0], 
          RGBColor[1, 0, 0]}, $CellContext`colors = {
          Hue[0.73], 
          Hue[1.46], 
          Hue[2.19], 
          Hue[2.92], 
          ...
          Hue[14.6]}, 
        Attributes[Thick] = {
         ReadProtected}, $CellContext`u = {-0.8449668365194433, 
         0.6545084971874737, 0.7557613140761708}, 
        Attributes[PlotRange] = {ReadProtected}}; Typeset`initDone$$ = True); 
     ReleaseHold[{{
         HoldComplete[$CellContext`colors = Table[
             Hue[0.73 $CellContext`n], {$CellContext`n, 1, 20}]; Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`fourcolors = {Red, Blue, Green, Yellow}; 
          Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`randomfourcolors = Table[
             
             Part[$CellContext`fourcolors, 1 + 
              RandomInteger[3]], {$CellContext`i, 20}]; Null]}}]; 
...
Cell["\<\
The rotational symmetries of the Platonic solids are illustrated. Each face \
can be a different color, or you can assign a random four-coloring of the \
faces.\
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ButtonBox["Platonic Solid",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/PlatonicSolid.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Rotational Symmetries of Platonic Solids",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
RotationalSymmetriesOfPlatonicSolids/"], None}],
 " (",
...
RotationalSymmetriesOfColoredPlatonicSolids&version=0012"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
RotationalSymmetriesOfColoredPlatonicSolids/\
RotationalSymmetriesOfColoredPlatonicSolids-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Rotational Symmetries of Colored Platonic Solids ",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
RotationalSymmetriesOfColoredPlatonicSolids/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
RotationalSymmetriesOfColoredPlatonicSolids/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[59906, 1190, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[60167, 1199, 2427, 54, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[70127, 1442, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 96828, 2011},
 {"Copyright", 97025, 2016}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[613, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34944, 590, 70, 0, 70, "DemoTitle"],
Cell[35017, 592, 24686, 590, 70, "Output",
 CellID->320162457],
Cell[59706, 1184, 197, 4, 70, "ManipulateCaption"],
Cell[59906, 1190, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[60167, 1199, 2427, 54, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[62597, 1255, 44, 0, 70, "RelatedLinksSection"],
Cell[62644, 1257, 567, 20, 70, "RelatedLinks",
 CellID->337774974],
Cell[63214, 1279, 450, 14, 70, "RelatedLinks",
 CellID->33969168],
Cell[63667, 1295, 4872, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[68542, 1388, 45, 0, 70, "CitationSection"],
Cell[68590, 1390, 945, 27, 70, "Citations"],
Cell[69538, 1419, 321, 10, 70, "Author"],
Cell[69862, 1431, 262, 9, 70, "Author",
 CellID->460911410],
Cell[70127, 1442, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature iSaLdszFGIgHlvQ7yqaUrIH0 *)
