...
NotebookDataLength[     81261,       1627]
NotebookOptionsPosition[     54929,       1058]
NotebookOutlinePosition[     81205,       1619]
CellTagsIndexPosition[     81094,       1613]
WindowTitle->Matrix Representation of the Permutation Group
WindowFrame->Normal*)
...
Cell["Matrix Representation of the Permutation Group", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`h$$ = {{0, 0, 1}, {0, 1, 0}, {1, 0, 
    0}}, $CellContext`k$$ = {{0, 0, 1}, {1, 0, 0}, {0, 1, 
    0}}, $CellContext`n$$ = 3, $CellContext`p$$ = {3, 2, 
    1}, $CellContext`perm1$$ = 5, $CellContext`perm2$$ = 
    4, $CellContext`q$$ = {3, 1, 2}, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`h$$], {{0, 0, 1}, {0, 1, 0}, {1, 0, 0}}}, 0}, {{
       Hold[$CellContext`k$$], {{0, 0, 1}, {1, 0, 0}, {0, 1, 0}}}, 0}, {{
       Hold[$CellContext`p$$], {3, 2, 1}}, 0}, {{
       Hold[$CellContext`q$$], {3, 1, 2}}, 0}, {{
       Hold[$CellContext`n$$], 3, "size of permutation"}, 3, 6, 1}, {{
       Hold[$CellContext`perm1$$], 5, "first permutation"}, 0, 
      Dynamic[Factorial[$CellContext`n$$] - 1], 1}, {{
       Hold[$CellContext`perm2$$], 4, "second permutation"}, 0, 
      Dynamic[Factorial[$CellContext`n$$] - 1], 1}}, Typeset`size$$ = {
    570., {197., 203.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n$16846$$ = 
    0, $CellContext`perm1$16847$$ = 0, $CellContext`perm2$16848$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`h$$ = {{0, 0, 1}, {0, 1, 0}, {1, 0, 
         0}}, $CellContext`k$$ = {{0, 0, 1}, {1, 0, 0}, {0, 1, 
         0}}, $CellContext`n$$ = 
        3, $CellContext`p$$ = {3, 2, 1}, $CellContext`perm1$$ = 
        5, $CellContext`perm2$$ = 4, $CellContext`q$$ = {3, 1, 2}}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$16846$$, 0], 
        Hold[$CellContext`perm1$$, $CellContext`perm1$16847$$, 0], 
        Hold[$CellContext`perm2$$, $CellContext`perm2$16848$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[Length[$CellContext`p$$] != $CellContext`n$$, $CellContext`perm1$$ = 
          5; $CellContext`perm2$$ = 4; Null]; $CellContext`p$$ = 
        Combinatorica`UnrankPermutation[$CellContext`perm1$$, 
          Range[$CellContext`n$$]]; $CellContext`q$$ = 
        Combinatorica`UnrankPermutation[$CellContext`perm2$$, 
          Range[$CellContext`n$$]]; $CellContext`h$$ = ($CellContext`k$$ = 
         Table[0, {$CellContext`n$$}, {$CellContext`n$$}]); 
       MapIndexed[(Part[$CellContext`h$$, 
           Part[#2, 1], #] = 1)& , $CellContext`p$$]; 
       MapIndexed[(Part[$CellContext`k$$, 
           Part[#2, 1], #] = 1)& , $CellContext`q$$]; Pane[
         Text[
          Column[{
            Row[{
              MatrixForm[{
                Range[$CellContext`n$$], 
                Map[Style[#, Red]& , $CellContext`p$$]}], " ", 
              MatrixForm[{
                Range[$CellContext`n$$], 
                Map[Style[#, Red]& , $CellContext`q$$]}], " = ", 
              MatrixForm[{
                Range[$CellContext`n$$], 
                Map[Style[#, Red]& , 
                 Part[$CellContext`q$$, $CellContext`p$$]]}]}], 
            Row[{
              MatrixForm[
               ReplaceAll[$CellContext`h$$, 1 -> Style[1, Red]]], " ", 
              MatrixForm[
               ReplaceAll[$CellContext`k$$, 1 -> Style[1, Red]]], " = ", 
              MatrixForm[
               ReplaceAll[
                Dot[$CellContext`h$$, $CellContext`k$$], 1 -> 
                Style[1, Red]]]}]}, Spacings -> 4]], Center, ImageSizeAction -> 
         "ResizeToFit", ImageSize -> {570, 400}, 
         Alignment -> {Center, Center}]), 
      "Specifications" :> {{{$CellContext`h$$, {{0, 0, 1}, {0, 1, 0}, {1, 0, 
          0}}}, 0, ControlType -> 
         None}, {{$CellContext`k$$, {{0, 0, 1}, {1, 0, 0}, {0, 1, 0}}}, 0, 
         ControlType -> None}, {{$CellContext`p$$, {3, 2, 1}}, 0, ControlType -> 
         None}, {{$CellContext`q$$, {3, 1, 2}}, 0, ControlType -> 
         None}, {{$CellContext`n$$, 3, "size of permutation"}, 3, 6, 1, 
         ControlType -> 
         Setter}, {{$CellContext`perm1$$, 5, "first permutation"}, 0, 
         Dynamic[Factorial[$CellContext`n$$] - 1], 1, Appearance -> 
         "Labeled"}, {{$CellContext`perm2$$, 4, "second permutation"}, 0, 
         Dynamic[Factorial[$CellContext`n$$] - 1], 1, Appearance -> 
         "Labeled"}}, "Options" :> {AutorunSequencing :> {2, 3}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{615., {268., 273.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>((Quiet[
        Get["Combinatorica`"]]; Null); Typeset`initDone$$ = True),
...
Cell[TextData[{
 ...
 " forms a group under the multiplication (composition) of permutations; that \
is, it meets the requirements of closure, existence of identity and inverses, \
and associativity. We can set up a bijection between ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["S", "n"], TraditionalForm]], "InlineMath"],
 " and a set of binary ",
 ...
 " matrices (the permutation matrices) that preserves this structure under \
the operation of matrix multiplication. The bijection associates the \
permutation ",
 Cell[BoxData[
  FormBox[
   RowBox[{"p", "=", 
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["P", "p"], TraditionalForm]], "InlineMath"],
...
Cell[TextData[{
 ButtonBox["Permutation Matrix",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/PermutationMatrix.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/PermutationMatrix.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Permutation Notations",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PermutationNotations/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PermutationNotations/"],
 " (",
...
MatrixRepresentationOfThePermutationGroup&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
MatrixRepresentationOfThePermutationGroup/\
MatrixRepresentationOfThePermutationGroup-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Matrix Representation of the Permutation Group",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
MatrixRepresentationOfThePermutationGroup/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
MatrixRepresentationOfThePermutationGroup/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[42575, 759, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[42836, 768, 3766, 82, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54107, 1033, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80807, 1602},
 {"Copyright", 81002, 1607}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1295, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35626, 600, 67, 0, 70, "DemoTitle"],
Cell[35696, 602, 5174, 100, 70, "Output",
 CellID->2061834274],
Cell[40873, 704, 1699, 53, 70, "ManipulateCaption"],
Cell[42575, 759, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[42836, 768, 3766, 82, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46605, 852, 44, 0, 70, "RelatedLinksSection"],
Cell[46652, 854, 643, 21, 70, "RelatedLinks",
 CellID->36096555],
Cell[47298, 877, 487, 14, 70, "RelatedLinks",
 CellID->373879058],
Cell[47788, 893, 4866, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[52657, 986, 45, 0, 70, "CitationSection"],
Cell[52705, 988, 354, 11, 70, "Author"],
Cell[53062, 1001, 1042, 30, 70, "Citations"],
Cell[54107, 1033, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature vQUrnjekRhbq#wAmmBfdg9it *)
