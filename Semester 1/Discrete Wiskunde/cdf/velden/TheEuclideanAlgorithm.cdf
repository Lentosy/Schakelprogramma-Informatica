...
NotebookDataLength[     76538,       1527]
NotebookOptionsPosition[     49432,        943]
NotebookOutlinePosition[     75681,       1504]
CellTagsIndexPosition[     75570,       1498]
WindowTitle->The Euclidean Algorithm
WindowFrame->Normal*)
...
Cell["The Euclidean Algorithm", "DemoTitle",
 CellID->700863240],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 10, $CellContext`b$$ = 
    3, $CellContext`n$$ = 1, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`a$$], 10, "first number (width)"}, 1, 15, 1}, {{
       Hold[$CellContext`b$$], 3, "second number (height)"}, 1, 15, 1}, {{
       Hold[$CellContext`n$$], 1, "step in algorithm"}, 0, 1}}, 
    Typeset`size$$ = {450., {223., 227.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`a$63061$$ = 0, $CellContext`b$63062$$ = 
    0, $CellContext`n$63063$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = 10, $CellContext`b$$ = 
        3, $CellContext`n$$ = 1}, "ControllerVariables" :> {
        Hold[$CellContext`a$$, $CellContext`a$63061$$, 0], 
        Hold[$CellContext`b$$, $CellContext`b$63062$$, 0], 
        Hold[$CellContext`n$$, $CellContext`n$63063$$, 0]}, 
      "OtherVariables" :> {
      ...
      With[{$CellContext`cf$ = 
         If[$CellContext`a$$ < $CellContext`b$$, Rest, Identity][
           ContinuedFraction[$CellContext`a$$/$CellContext`b$$]]}, 
        Part[
         Map[Graphics[{
            PointSize[0.007], {
             GrayLevel[0.75], 
             Rectangle[{-$CellContext`a$$, 0}, {0, $CellContext`b$$}]}, #, 
            Table[
             
             Point[{-$CellContext`i, $CellContext`j}], {$CellContext`i, 
              0, $CellContext`a$$}, {$CellContext`j, 0, $CellContext`b$$}]}, 
           PlotRange -> 
           If[$CellContext`a$$ < $CellContext`b$$, {{(-($CellContext`b$$ + \
$CellContext`a$$ + 1))/2, ($CellContext`b$$ - $CellContext`a$$ + 1)/
               2}, {-0.5, $CellContext`b$$ + 0.5}}, {{-$CellContext`a$$ - 0.5,
                0.5}, {(-($CellContext`a$$ - $CellContext`b$$ + 1))/
               2, ($CellContext`a$$ + $CellContext`b$$ + 1)/2}}], PlotLabel -> 
           Style[
             
             Row[{"The greatest common divisor of ", $CellContext`a$$, 
               " and ", $CellContext`b$$, " is ", 
               GCD[$CellContext`a$$, $CellContext`b$$], "."}], 16], 
           ImageSize -> {450, 450}]& , 
          FoldList[Append, {}, 
           MapIndexed[
           With[{$CellContext`min$ = # {-1, 1}, $CellContext`max$ = (# - 
                Min[#]) {-1, 1}}, {{
               Hue[Part[
                  Position[
                   Rest[
                    FoldList[Plus, 0, $CellContext`cf$]], 
                   Condition[
                    Pattern[$CellContext`n, 
                    Blank[]], Part[#2, 1] - 1 < $CellContext`n], 1, 1], 1]/
                Length[$CellContext`cf$]], 
               Rectangle[$CellContext`min$, $CellContext`max$]}, 
              Line[{$CellContext`min$, {
                 Part[$CellContext`min$, 1], 
                 Part[$CellContext`max$, 2]}, $CellContext`max$, {
                 Part[$CellContext`max$, 1], 
                 Part[$CellContext`min$, 2]}, $CellContext`min$}]}]& , 
            Drop[
             FixedPointList[
             Apply[If[# > #2, {# - #2, #2}, {#, #2 - #}]& , #]& , \
{$CellContext`a$$, $CellContext`b$$}], -2]]]], 
         Ceiling[$CellContext`n$$ Total[$CellContext`cf$]] + 1]], 
      "Specifications" :> {{{$CellContext`a$$, 10, "first number (width)"}, 1,
          15, 1}, {{$CellContext`b$$, 3, "second number (height)"}, 1, 15, 1},
         Delimiter, {{$CellContext`n$$, 1, "step in algorithm"}, 0, 1}}, 
      "Options" :> {AutorunSequencing -> {{1, 6}, {2, 6}}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{495., {302., 307.}},
...
Cell[TextData[{
 "A graphical interpretation of Euclid's algorithm for calculating the \
greatest common divisor of two numbers: Given numbers ",
 Cell[BoxData[
 ...
 Cell[BoxData[
  FormBox["y", TraditionalForm]], "InlineMath"],
 ".  If this rectangle is divided into squares as shown in the ",
 "Demonstration",
 ", then the width of the smallest square (shown in red) is the greatest \
common divisor of ",
 Cell[BoxData[
  FormBox["x", TraditionalForm]], "InlineMath"],
 " and ",
...
Cell[TextData[{
 ButtonBox["History of Continued Fractions",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.wolframscience.com/nksonline/page-915a-text"], None}],
 " (",
...
TheEuclideanAlgorithm&version=0032"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/TheEuclideanAlgorithm/\
TheEuclideanAlgorithm-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["The Euclidean Algorithm",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheEuclideanAlgorithm/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TheEuclideanAlgorithm/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/TheEuclideanAlgorithm/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/TheEuclideanAlgorithm/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/TheEuclideanAlgorithm/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Matthew Szudzik",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Matthew+\
Szudzik"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Matthew+Szudzik"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40225, 711, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40486, 720, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48610, 918, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75285, 1487},
 {"Copyright", 75479, 1492}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34918, 590, 64, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[34985, 593, 4403, 89, 70, "Output",
 CellID->377009605],
Cell[39391, 684, 831, 25, 70, "ManipulateCaption",
 CellID->258496835],
Cell[40225, 711, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40486, 720, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41180, 737, 44, 0, 70, "RelatedLinksSection"],
Cell[41227, 739, 578, 20, 70, "RelatedLinks",
 CellID->1368054309],
Cell[41808, 761, 448, 14, 70, "RelatedLinks",
 CellID->1492087182],
Cell[42259, 777, 4802, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47064, 868, 45, 0, 70, "CitationSection"],
Cell[47112, 870, 791, 20, 70, "Citations"],
Cell[47906, 892, 350, 11, 70, "Author",
 CellID->494616589],
Cell[48259, 905, 348, 11, 70, "Author",
 CellID->219019384],
Cell[48610, 918, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature 7TUwUbM8MhFdawmyWFmYzUmM *)
