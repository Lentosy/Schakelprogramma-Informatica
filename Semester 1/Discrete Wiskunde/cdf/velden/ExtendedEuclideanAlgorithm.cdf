...
NotebookDataLength[     86719,       1835]
NotebookOptionsPosition[     60288,       1260]
NotebookOutlinePosition[     86304,       1815]
CellTagsIndexPosition[     86231,       1810]
WindowTitle->Extended Euclidean Algorithm
WindowFrame->Normal*)
...
Cell["Extended Euclidean Algorithm", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`ba$$ = {987, 610}, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`ba$$], {987, 610}, "a, b"}, {1, 2}, {999, 999}, {1, 
      1}}}, Typeset`size$$ = {600., {147.5, 152.5}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`ba$21281$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`ba$$ = {987, 610}}, 
      "ControllerVariables" :> {
        Hold[$CellContext`ba$$, $CellContext`ba$21281$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Text[
         TraditionalForm[
          $CellContext`ExtendedEuclideanAlgorithm[$CellContext`ba$$]]], 
        ImageSize -> {600, 300}], 
      "Specifications" :> {{{$CellContext`ba$$, {987, 610}, "a, b"}, {1, 2}, {
         999, 999}, {1, 1}}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{645., {221., 226.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`ExtendedEuclideanAlgorithm[{
           PatternTest[
           ...
           PatternTest[
            Pattern[$CellContext`b, 
             Blank[Integer]], Positive]}] := 
        Module[{$CellContext`steps = {
            1, $CellContext`a, $CellContext`b}, $CellContext`backSteps = \
{{$CellContext`a, 1, 0}, {$CellContext`b, 0, 1}}}, $CellContext`steps = Rest[
             NestWhileList[{
               Part[#, 2], 
               Part[#, 3], 
               Mod[
                Part[#, 2], 
                Part[#, 3]]}& , $CellContext`steps, Part[#, 3] > 0& ]]; 
          If[Length[$CellContext`steps] === 1, $CellContext`steps = {{
               Part[$CellContext`steps, 1, 1], 
               Part[$CellContext`steps, 1, 2], 0}}]; While[Part[
              Last[$CellContext`backSteps], 1] > 0, $CellContext`backSteps = 
            Append[$CellContext`backSteps, 
              ({
               Mod[
                Part[
                 Last[
                ...
                Part[
                 ...
                 Last[
                  ...
                  Last[#], 1]] Part[
                 Last[#], 
                 3]}& )[$CellContext`backSteps]]]; $CellContext`backSteps = 
           Map[$CellContext`ss, 
             Most[$CellContext`backSteps], {2}]; Row[{
             Column[
              Quiet[{
                Row[
                 Map[Text[
                   ...
                   Style[#, Blue, 
                    Bold]]& , {$CellContext`gcd[$CellContext`a, \
$CellContext`b] == GCD[$CellContext`a, $CellContext`b]}]], 
                Row[
                 Table["", {$CellContext`j, 7}]], 
                Row[
                 Table["", {$CellContext`j, 7}]], 
                Grid[
                 Apply[{
                   ...
                   If[#2 === 0, 
                    PaddedForm[#, 3], 
                    PaddedForm[#2, 3]], " \[Times] ", 
                   PaddedForm[
                    IntegerPart[#/#2], 3], " + ", 
                   PaddedForm[#3, 3]}& , $CellContext`steps, {1}], 
                 Alignment -> {Right}, 
                 ItemSize -> {{3, 2, 2, 2, 2, 2, 2}, All}]}]], 
             TraditionalForm[
              Grid[
               Table[{
                 If[$CellContext`i <= 2, 
                  Item[" ", ItemSize -> 1], 
                  Item[
                  "\[DoubleRightArrow]", ItemSize -> 1]]}, {$CellContext`i, 
                 Length[$CellContext`backSteps]}], Background -> White, Frame -> 
               False]], 
             TraditionalForm[
              Column[{
                Row[
                 Map[Text[
                   Style[#, Red, Bold]]& , {
                   GCD[$CellContext`a, $CellContext`b], " = ", $CellContext`a,
                    " \[Times] ", 
                   Part[
                    Last[$CellContext`backSteps], 2], "  +  ", $CellContext`b,
                    " \[Times] ", 
                   Part[
                    Last[$CellContext`backSteps], 3]}]], 
                Quiet[
                 Grid[
                  Apply[{
                    PaddedForm[#, 3], " = ", 
                    PaddedForm[$CellContext`a, 3], " \[Times] ", 
                    PaddedForm[#2, 4], " + ", 
                    PaddedForm[$CellContext`b, 3], " \[Times] ", 
                    PaddedForm[#3, 3]}& , $CellContext`backSteps, {1}], 
                  Alignment -> {Right}, 
                  ItemSize -> {{2, 2, 2, 2, 3, 2, 3, 2, 3}, All}]], 
                Row[
                 Map[Text[
                   Style[#, Red, Bold]]& , 
                  Table[" ", {$CellContext`i, 9}]]]}]]}]], $CellContext`ss[
          Pattern[$CellContext`x, 
           Blank[]]] := If[
          Negative[$CellContext`x], 
          StringJoin["(", 
           ToString[$CellContext`x], ")"], 
          ToString[$CellContext`x]]}; Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`ss[
           Pattern[$CellContext`x, 
            Blank[]]] := If[
           Negative[$CellContext`x], 
           StringJoin["(", 
            ToString[$CellContext`x], ")"], 
           ToString[$CellContext`x]], $CellContext`ExtendedEuclideanAlgorithm[{
             PatternTest[
              Pattern[$CellContext`a, 
               Blank[Integer]], Positive], 
             PatternTest[
                ...
                Grid[
                 Table[{
                   If[$CellContext`i <= 2, 
                    ...
                    Item[
                    "\[DoubleRightArrow]", ItemSize -> 1]]}, {$CellContext`i, 
                   Length[$CellContext`backSteps]}], Background -> White, 
                 Frame -> False]], 
               TraditionalForm[
                Column[{
                  Row[
                   Map[Text[
                    Style[#, Red, Bold]]& , {
                    GCD[$CellContext`a, $CellContext`b], 
                    " = ", $CellContext`a, " \[Times] ", 
                    Part[
                    Last[$CellContext`backSteps], 2], "  +  ", $CellContext`b,
                     " \[Times] ", 
...
Cell[TextData[{
 ...
 " can be found by the Euclidean algorithm by successive repeated application \
of the division algorithm. The extended Euclidean algorithm not only computes \
",
 Cell[BoxData[
  FormBox[
   RowBox[{"gcd", "(", 
   ...
   RowBox[{
    ...
    RowBox[{
     RowBox[{"a", " ", 
      SubscriptBox["s", "i"]}], "+", 
     RowBox[{"b", "  ", 
      SubscriptBox["t", "i"], Cell["", "InlineMath"]}]}]}], TraditionalForm]],
   "InlineMath"],
 ", where ",
 Cell[BoxData[
  FormBox[
   ...
   RowBox[{
    ...
    RowBox[{
     ...
     RowBox[{
      ...
      SubscriptBox["t", 
       RowBox[{"i", "-", "1"}]]}]}]}], TraditionalForm]], "InlineMath"],
 ", respectively. This forward method requires no back substitutions and \
reduces the amount of computation involved in finding the coefficients ",
 Cell[BoxData[
  FormBox["s", TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
...
Cell[TextData[{
 "The result saying that the greatest common divisor of any two integers ",
 Cell[BoxData[
  FormBox["a", TraditionalForm]], "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox["b", TraditionalForm]], "InlineMath"],
 " can be written as their linear combination is also known as the Bachet\
\[Dash]B\[EAcute]zout theorem (actually, B\[EAcute]zout formulated it for \
polynomials)."
}], "DetailNotes",
 CellID->108230964],
...
Cell[TextData[{
 ...
 ButtonBox["Extended Euclidean algorithm",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://en.wikipedia.org/wiki/Extended_Euclidean_algorithm"], None},
  ButtonNote->"http://en.wikipedia.org/wiki/Extended_Euclidean_algorithm"],
 "."
}], "DetailNotes",
 CellID->414384376],
...
Cell[TextData[{
 ...
 StyleBox["Mathematica",
  FontSlant->"Italic"],
 " code is an adaptation of the code used in the Demonstration ",
 ButtonBox["Euclidean Algorithm Steps",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/EuclideanAlgorithmSteps/"], None}],
 " by Michael Trott. "
}], "DetailNotes",
 CellID->281550359],

Cell["\<\
(The author was supported by project 1ET200300529 of the Information Society \
of the National Research Program of the Czech Republic and by the \
Institutional Research Plan AV0Z10300504; the Demonstration was submitted \
2008-06-20, revised 2010-03-13.)\
\>", "DetailNotes",
 CellID->837629190],
...
Cell[TextData[{
 ButtonBox["Euclidean Algorithm",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/EuclideanAlgorithm.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Greatest Common Divisor",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/GreatestCommonDivisor.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["B\[EAcute]zout's Theorem",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/BezoutsTheorem.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ExtendedEuclideanAlgorithm&version=0018"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ExtendedEuclideanAlgorithm/\
ExtendedEuclideanAlgorithm-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 ...
 ButtonBox["Extended Euclidean Algorithm",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ExtendedEuclideanAlgorithm/"], 
    None},
  ButtonNote->"http://demonstrations.wolfram.com/ExtendedEuclideanAlgorithm/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ExtendedEuclideanAlgorithm/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ExtendedEuclideanAlgorithm/"], 
    None},
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["\[CapitalSHacek]tefan Porubsk\[YAcute]",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Stefan+Porubsk%\
FD"], None}]
}], "Author",
...
CellTagsIndex->{
 "Copyright"->{
  Cell[59466, 1235, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 86139, 1804}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1277, 31, 34328, 567, 70, "DemonstrationHeader"],
Cell[35608, 600, 49, 0, 70, "DemoTitle"],
Cell[35660, 602, 10631, 252, 70, "Output",
 CellID->336223524],
Cell[46294, 856, 3201, 109, 70, "ManipulateCaption",
 CellID->93952131],
Cell[49498, 967, 33, 0, 70, "DetailsSection"],
Cell[49534, 969, 434, 11, 70, "DetailNotes",
 CellID->108230964],
Cell[49971, 982, 352, 9, 70, "DetailNotes",
 CellID->414384376],
Cell[50326, 993, 373, 11, 70, "DetailNotes",
 CellID->281550359],
Cell[50702, 1006, 306, 6, 70, "DetailNotes",
 CellID->837629190],
Cell[51011, 1014, 44, 0, 70, "RelatedLinksSection"],
Cell[51058, 1016, 576, 20, 70, "RelatedLinks",
 CellID->61598048],
Cell[51637, 1038, 420, 13, 70, "RelatedLinks",
 CellID->11591199],
Cell[52060, 1053, 584, 20, 70, "RelatedLinks",
 CellID->254464062],
Cell[52647, 1075, 577, 20, 70, "RelatedLinks",
 CellID->99371890],
Cell[53227, 1097, 4817, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[58047, 1188, 45, 0, 70, "CitationSection"],
Cell[58095, 1190, 831, 22, 70, "Citations"],
Cell[58929, 1214, 265, 8, 70, "Author"],
Cell[59197, 1224, 266, 9, 70, "Author",
 CellID->315822471],
Cell[59466, 1235, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature VREOo9U#hHFPPxQVKha9lywE *)
