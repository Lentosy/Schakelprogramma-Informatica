...
NotebookDataLength[     72871,       1437]
NotebookOptionsPosition[     46240,        865]
NotebookOutlinePosition[     72244,       1420]
CellTagsIndexPosition[     72171,       1415]
WindowTitle->Continued Fractions
WindowFrame->Normal*)
...
Cell["Continued Fractions", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`e$$ = 2, $CellContext`len$$ = 
    5, $CellContext`n$$ = 2, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 2, "number"}, 2, 10, 1}, {{
       Hold[$CellContext`e$$], 2, "root"}, 2, 6, 1}, {{
       Hold[$CellContext`len$$], 5, "terms"}, 1, 25, 1}}, Typeset`size$$ = {
    450., {184., 190.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`n$731$$ = 
    0, $CellContext`e$732$$ = 0, $CellContext`len$733$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`e$$ = 2, $CellContext`len$$ = 
        5, $CellContext`n$$ = 2}, "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$731$$, 0], 
        Hold[$CellContext`e$$, $CellContext`e$732$$, 0], 
        Hold[$CellContext`len$$, $CellContext`len$733$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Text[
        With[{$CellContext`cf$ = If[
            
            IntegerQ[$CellContext`n$$^(
              1/$CellContext`e$$)], {$CellContext`n$$^(1/$CellContext`e$$)}, 
            
            ContinuedFraction[$CellContext`n$$^(
              1/$CellContext`e$$), $CellContext`len$$]]}, 
         Column[{
           Row[{
             Framed[
              Style[
               Pane[
                DisplayForm[
                 RadicalBox[$CellContext`n$$, $CellContext`e$$]], {
                Automatic, 30}], Large], Background -> LightYellow], 
             " \[TildeEqual]"}], 
           Pane[
            (TraditionalForm[
             Fold[#^(-1) + #2& , 
              ...
              Rest[
               Reverse[#]]]]& )[
             Map[ToString, $CellContext`cf$]], {450, 300}, 
            Alignment -> {Left, Center}], 
           With[{$CellContext`fcf = FromContinuedFraction[$CellContext`cf$]}, 
            Pane[
             Row[{"= ", $CellContext`fcf, " \[TildeEqual] ", 
               N[$CellContext`fcf, 20]}], {Automatic, 20}]]}]]], 
      "Specifications" :> {{{$CellContext`n$$, 2, "number"}, 2, 10, 
         1}, {{$CellContext`e$$, 2, "root"}, 2, 6, 
         1}, {{$CellContext`len$$, 5, "terms"}, 1, 25, 1, Appearance -> 
         "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{495., {256., 261.}},
...
Cell["\<\
This Demonstration shows continued fraction representations for several \
numbers. Square roots eventually yield repetitive sequences in this \
representation, but cube roots and higher powers yield seemingly random \
sequences.\
\>", "ManipulateCaption",
 CellID->1044312921],
...
Cell[TextData[{
 ButtonBox["Continued Fraction",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/ContinuedFraction.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Mathematical Constants",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://wolframscience.com/nksonline/page-144"], None}],
 " (",
...
ContinuedFractions&version=0022"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ContinuedFractions/ContinuedFractions-\
...
Cell[TextData[{
 ...
 ButtonBox["Continued Fractions",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ContinuedFractions/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ContinuedFractions/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ContinuedFractions/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ContinuedFractions/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ContinuedFractions/"]
...
CellTagsIndex->{
 "Copyright"->{
  Cell[45418, 840, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 72080, 1409}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34914, 590, 60, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[34977, 593, 3119, 69, 70, "Output",
 CellID->1227065263],
Cell[38099, 664, 286, 6, 70, "ManipulateCaption",
 CellID->1044312921],
Cell[38388, 672, 44, 0, 70, "RelatedLinksSection"],
Cell[38435, 674, 576, 20, 70, "RelatedLinks",
 CellID->1375309533],
Cell[39014, 696, 429, 14, 70, "RelatedLinks",
 CellID->307878655],
Cell[39446, 712, 4793, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[44242, 803, 45, 0, 70, "CitationSection"],
Cell[44290, 805, 772, 20, 70, "Citations"],
Cell[45065, 827, 350, 11, 70, "Author",
 CellID->101561785],
Cell[45418, 840, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature pRE2yBtkJhN8YxmcHULgydQw *)
