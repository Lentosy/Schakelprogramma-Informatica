...
NotebookDataLength[     77338,       1554]
NotebookOptionsPosition[     50282,        973]
NotebookOutlinePosition[     76537,       1534]
CellTagsIndexPosition[     76426,       1528]
WindowTitle->Powers in Modular Arithmetic
WindowFrame->Normal*)
...
Cell["Powers in Modular Arithmetic", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`m$$ = 7, $CellContext`n$$ = 5, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`m$$], 7, "modulus m (m-1 vertices)"}, 2, 24, 1}, {{
       Hold[$CellContext`n$$], 5, "power n"}, 0, 
      Dynamic[$CellContext`m$$], 1}}, Typeset`size$$ = {380., {158., 164.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`m$918$$ = 0, $CellContext`n$919$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`m$$ = 7, $CellContext`n$$ = 5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`m$$, $CellContext`m$918$$, 0], 
        Hold[$CellContext`n$$, $CellContext`n$919$$, 0]}, 
      "OtherVariables" :> {
      ...
      "Body" :> (
       If[$CellContext`n$$ > $CellContext`m$$, $CellContext`n$$ = \
$CellContext`m$$]; $CellContext`selectededges = Apply[Rule, 
          Transpose[{
            Range[$CellContext`m$$], 
            Mod[
            Range[$CellContext`m$$]^$CellContext`n$$, $CellContext`m$$, 
             1]}], {1}]; $CellContext`alledges = Apply[Rule, 
          Flatten[
           
           Table[{$CellContext`i, $CellContext`j}, {$CellContext`j, \
$CellContext`m$$ - 1}, {$CellContext`i, $CellContext`m$$ - 1}], 1], {1}]; Pane[
         GraphPlot[$CellContext`alledges, Method -> "CircularEmbedding", 
          DirectedEdges -> True, EdgeRenderingFunction -> (If[
            MemberQ[
             Apply[List, $CellContext`selectededges, {1}], #2], {Blue, 
             Arrow[#]}, {LightGray, Dashed, 
             Line[#]}]& )], 380]), 
      "Specifications" :> {{{$CellContext`m$$, 7, "modulus m (m-1 vertices)"},
          2, 24, 1, Appearance -> 
         "Labeled"}, {{$CellContext`n$$, 5, "power n"}, 0, 
         Dynamic[$CellContext`m$$], 1, Appearance -> "Labeled"}}, 
      "Options" :> {TrackedSymbols -> Manipulate, AutorunSequencing -> {2}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{425., {217., 222.}},
...
Cell[TextData[{
 ...
 " are arranged around a circle. An arrow joins a number to its power; in \
  ...
  FormBox[
   RowBox[{"y", "\[Congruent]", 
    RowBox[{
     SuperscriptBox["x", "n"], " ", 
     RowBox[{"(", 
      RowBox[{"mod", " ", "m"}], ")"}]}]}], TraditionalForm]], "InlineMath"],
 " with ",
 Cell[BoxData[
  FormBox[
   RowBox[{"y", "\[NotCongruent]", 
    RowBox[{"0", " ", 
     RowBox[{"(", 
      RowBox[{"mod", " ", "m"}], ")"}]}]}], TraditionalForm]], "InlineMath"],
 ", then an arrow is drawn from ",
 Cell[BoxData[
...
Cell[TextData[{
 ButtonBox["Modular Arithmetic",
  ...
  ButtonNote->"http://mathworld.wolfram.com/ModularArithmetic.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Fermat's Little Theorem",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/FermatsLittleTheorem.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/FermatsLittleTheorem.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Quadratic Residue",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/QuadraticResidue.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/QuadraticResidue.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
PowersInModularArithmetic&version=0003"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/PowersInModularArithmetic/\
PowersInModularArithmetic-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Powers in Modular Arithmetic",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PowersInModularArithmetic/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PowersInModularArithmetic/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/PowersInModularArithmetic/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/PowersInModularArithmetic/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/PowersInModularArithmetic/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[38689, 684, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[38950, 693, 2503, 55, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49460, 948, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76140, 1517},
 {"Copyright", 76335, 1522}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34975, 592, 2806, 57, 70, "Output",
 CellID->78048032],
Cell[37784, 651, 902, 31, 70, "ManipulateCaption"],
Cell[38689, 684, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[38950, 693, 2503, 55, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41456, 750, 44, 0, 70, "RelatedLinksSection"],
Cell[41503, 752, 644, 21, 70, "RelatedLinks",
 CellID->608522425],
Cell[42150, 775, 655, 21, 70, "RelatedLinks",
 CellID->168542882],
Cell[42808, 798, 641, 21, 70, "RelatedLinks",
 CellID->521575960],
Cell[43452, 821, 4814, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[48269, 912, 45, 0, 70, "CitationSection"],
Cell[48317, 914, 816, 20, 70, "Citations"],
Cell[49136, 936, 321, 10, 70, "Author"],
Cell[49460, 948, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature 7QaRw6NCRTB#kuQDczj9Mxjr *)
