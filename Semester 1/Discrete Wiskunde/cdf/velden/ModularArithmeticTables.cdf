...
NotebookDataLength[     74199,       1465]
NotebookOptionsPosition[     47691,        898]
NotebookOutlinePosition[     73701,       1453]
CellTagsIndexPosition[     73628,       1448]
WindowTitle->Modular Arithmetic Tables
WindowFrame->Normal*)
...
Cell["Modular Arithmetic Tables", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 16, $CellContext`op$$ = Plus, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 16, "modulus"}, 2, 16, 1}, {{
       Hold[$CellContext`op$$], Plus, ""}, {
      Plus -> "addition", Times -> "multiplication"}}}, Typeset`size$$ = {
    500., {172.5, 177.5}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`n$2393$$ = 
    0, $CellContext`op$2394$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`n$$ = 16, $CellContext`op$$ = Plus}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$2393$$, 0], 
        Hold[$CellContext`op$$, $CellContext`op$2394$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Text[
         $CellContext`grid[$CellContext`n$$, $CellContext`op$$]], 
        Alignment -> {Center, Center}, ImageSize -> {500, 350}, 
        ImageSizeAction -> "ShrinkToFit", BaseStyle -> {
          Darker[Blue], Background -> Lighter[Blue, 0.97]}], 
      "Specifications" :> {{{$CellContext`n$$, 16, "modulus"}, 2, 16, 1, 
         Appearance -> "Labeled"}, {{$CellContext`op$$, Plus, ""}, {
         Plus -> "addition", Times -> "multiplication"}}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {229., 234.}},
    ...
    Initialization:>(({$CellContext`grid[
          ...
          Join[{
            Prepend[
             ...
             If[
              TrueQ[$CellContext`op == Plus], "\[CirclePlus]", 
              "\[CircleTimes]"]]}, 
           Map[Prepend[#, 
             Part[#, 
              If[
               TrueQ[$CellContext`op == Plus], 1, 2]]]& , 
            $CellContext`table[$CellContext`n, $CellContext`op]]], 
          Dividers -> {{False, True}, {False, True}}, 
          Background -> {{LightGray}, {LightGray}}, ItemStyle -> {
            Directive[FontSize -> 16]}], $CellContext`table[
          Pattern[$CellContext`n, 
           Blank[]], 
          Pattern[$CellContext`op, 
           Blank[]]] := Table[
          Mod[
           $CellContext`op[$CellContext`i, $CellContext`j], $CellContext`n], \
{$CellContext`i, 0, $CellContext`n - 1}, {$CellContext`j, 0, $CellContext`n - 
           1}]}; Typeset`initDone$$ = True); ReleaseHold[{{
         HoldComplete[$CellContext`table[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`op, 
              Blank[]]] := Table[
             Mod[
              $CellContext`op[$CellContext`i, $CellContext`j], \
$CellContext`n], {$CellContext`i, 0, $CellContext`n - 1}, {$CellContext`j, 
              0, $CellContext`n - 1}]; Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`grid[
             Pattern[$CellContext`n, 
              Blank[]], 
             Pattern[$CellContext`op, 
              Blank[]]] := Grid[
...
Cell[TextData[{
 "Modular arithmetic tables are demonstrated for addition ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"a", 
     SubscriptBox["\[CirclePlus]", "n"], "b"}], "=", 
    RowBox[{"a", "+", 
     RowBox[{"b", " ", 
      RowBox[{"(", 
...
ModularArithmeticTables&version=0015"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ModularArithmeticTables/\
ModularArithmeticTables-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Modular Arithmetic Tables",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularArithmeticTables/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularArithmeticTables/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ModularArithmeticTables/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularArithmeticTables/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularArithmeticTables/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Rudolf Muradian",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Rudolf+\
Muradian"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Rudolf+Muradian"]
}], "Author",
...
CellTagsIndex->{
 "Copyright"->{
  Cell[46869, 873, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 73537, 1442}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34969, 592, 4556, 102, 70, "Output",
 CellID->46448258],
Cell[39528, 696, 715, 24, 70, "ManipulateCaption"],
Cell[40246, 722, 44, 0, 70, "RelatedLinksSection"],
Cell[40293, 724, 575, 20, 70, "RelatedLinks",
 CellID->169742747],
Cell[40871, 746, 4808, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[45682, 837, 45, 0, 70, "CitationSection"],
Cell[45730, 839, 803, 20, 70, "Citations"],
Cell[46536, 861, 330, 10, 70, "Author"],
Cell[46869, 873, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature JSqbCq7E@CkvIxQ1SDAmwjtP *)
