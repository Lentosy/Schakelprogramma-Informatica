...
NotebookDataLength[     73209,       1437]
NotebookOptionsPosition[     46595,        867]
NotebookOutlinePosition[     72632,       1422]
CellTagsIndexPosition[     72559,       1417]
WindowTitle->Modular Addition, Multiplication, and Exponentiation
WindowFrame->Normal*)
...
Cell["Modular Addition, Multiplication, and Exponentiation", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = 9, $CellContext`b$$ = 
    15, $CellContext`m$$ = 26, $CellContext`op$$ = Power, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`a$$], 5}, 0, 100, 1}, {{
       Hold[$CellContext`b$$], 10}, 0, 100, 1}, {{
       Hold[$CellContext`m$$], 23}, 2, 100, 1}, {{
       Hold[$CellContext`op$$], Power, ""}, {
      Plus -> "a + b (mod m)", Times -> "a b (mod m)", Power -> 
       "\!\(\*SuperscriptBox[\(a\), \(b\)]\) (mod m)"}}}, Typeset`size$$ = {
    400., {22.5, 27.5}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`a$42962$$ = 
    0, $CellContext`b$42963$$ = 0, $CellContext`m$42964$$ = 
    0, $CellContext`op$42965$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`a$$ = 5, $CellContext`b$$ = 
        10, $CellContext`m$$ = 23, $CellContext`op$$ = Power}, 
      "ControllerVariables" :> {
        Hold[$CellContext`a$$, $CellContext`a$42962$$, 0], 
        Hold[$CellContext`b$$, $CellContext`b$42963$$, 0], 
        Hold[$CellContext`m$$, $CellContext`m$42964$$, 0], 
        Hold[$CellContext`op$$, $CellContext`op$42965$$, False]}, 
      "OtherVariables" :> {
          ...
          Style[
           TraditionalForm[
            Row[{
              ...
              With[{$CellContext`a = $CellContext`a$$, $CellContext`b = \
$CellContext`b$$, $CellContext`m = $CellContext`m$$, $CellContext`op = \
$CellContext`op$$}, 
               HoldForm[
                $CellContext`op[$CellContext`a, $CellContext`b]]], 
              " \[Congruent] ", 
              Mod[
               $CellContext`op$$[$CellContext`a$$, $CellContext`b$$], \
$CellContext`m$$], " (mod ", $CellContext`m$$, ")"}]], 28]], 
         ImageSize -> {400, 50}, Alignment -> {Center, Center}, BaseStyle -> {
           Darker[Blue, 0.6], Background -> Lighter[Blue, 0.98]}]], 
      "Specifications" :> {{{$CellContext`a$$, 5}, 0, 100, 1, Appearance -> 
         "Labeled"}, {{$CellContext`b$$, 10}, 0, 100, 1, Appearance -> 
         "Labeled"}, {{$CellContext`m$$, 23}, 2, 100, 1, Appearance -> 
         "Labeled"}, 
        Delimiter, {{$CellContext`op$$, Power, ""}, {
         Plus -> "a + b (mod m)", Times -> "a b (mod m)", Power -> 
          "\!\(\*SuperscriptBox[\(a\), \(b\)]\) (mod m)"}}}, 
      "Options" :> {AutorunSequencing -> All}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{445., {115., 120.}},
...
Cell["\<\
This Demonstration explores various operations in modular arithmetic. Change \
the arguments of the operation and the modulus to understand how modular \
arithmetic works.\
\>", "ManipulateCaption",
 CellID->717890144],
...
ModularAdditionMultiplicationAndExponentiation&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
ModularAdditionMultiplicationAndExponentiation/\
ModularAdditionMultiplicationAndExponentiation-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Modular Addition, Multiplication, and Exponentiation",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
ModularAdditionMultiplicationAndExponentiation/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
ModularAdditionMultiplicationAndExponentiation/"],
 "\"",
...
CellTagsIndex->{
 "Copyright"->{
  Cell[45773, 842, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 72468, 1411}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35023, 592, 3307, 68, 70, "Output",
 CellID->745006645],
Cell[38333, 662, 228, 5, 70, "ManipulateCaption",
 CellID->717890144],
Cell[38564, 669, 44, 0, 70, "RelatedLinksSection"],
Cell[38611, 671, 575, 20, 70, "RelatedLinks",
 CellID->169742747],
Cell[39189, 693, 4881, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[44073, 786, 45, 0, 70, "CitationSection"],
Cell[44121, 788, 963, 27, 70, "Citations"],
Cell[45087, 817, 330, 10, 70, "Author"],
Cell[45420, 829, 350, 11, 70, "Author",
 CellID->75024291],
Cell[45773, 842, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature uTUJgpBKg@2SfxQtzE0rPeG3 *)
