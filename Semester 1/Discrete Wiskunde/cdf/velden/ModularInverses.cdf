...
NotebookDataLength[     76878,       1546]
NotebookOptionsPosition[     49666,        960]
NotebookOutlinePosition[     75909,       1521]
CellTagsIndexPosition[     75798,       1515]
WindowTitle->Modular Inverses
WindowFrame->Normal*)
...
Cell["Modular Inverses", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 120, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 103, "modulus"}, 2, 256, 1}}, 
    Typeset`size$$ = {450., {223., 227.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`n$129209$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`n$$ = 103}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$129209$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Circle[], 
         Table[{
           Hue[$CellContext`k/$CellContext`n$$], 
           Which[GCD[$CellContext`k, $CellContext`n$$] > 1, {
             Hue[0, 0, 0], 
             PointSize[0], 
             Point[
              $CellContext`P[$CellContext`k, $CellContext`n$$]]}, 
            PowerMod[$CellContext`k, -1, $CellContext`n$$] == $CellContext`k, {
             PointSize[0.03], 
             Point[
              $CellContext`P[$CellContext`k, $CellContext`n$$]]}, True, 
            Arrow[{
              $CellContext`P[$CellContext`k, $CellContext`n$$], 
              $CellContext`P[
               
               PowerMod[$CellContext`k, -1, $CellContext`n$$], \
$CellContext`n$$]}]]}, {$CellContext`k, 1, $CellContext`n$$ - 1}], 
         Table[{
           
           Text[$CellContext`k, 
            1.1 $CellContext`P[$CellContext`k, $CellContext`n$$]]}, \
{$CellContext`k, 0, $CellContext`n$$ - 
           Ceiling[$CellContext`n$$/$CellContext`Resolution], 
           Ceiling[$CellContext`n$$/$CellContext`Resolution]}]}, 
        ImageSize -> {450, 450}], 
      "Specifications" :> {{{$CellContext`n$$, 103, "modulus"}, 2, 256, 1, 
    ...
    Initialization:>(({$CellContext`P[
          ...
          Pattern[$CellContext`y, 
           Blank[]]] := {
          Cos[2 Pi - (2 $CellContext`x) (Pi/$CellContext`y) + Pi/2], 
          Sin[
          2 Pi - (2 $CellContext`x) (Pi/$CellContext`y) + 
           Pi/2]}, $CellContext`Resolution = 60}; Typeset`initDone$$ = True); 
     ReleaseHold[{{
         HoldComplete[$CellContext`Resolution = 60; Null], 
         HoldComplete[Null], 
         HoldComplete[P[
            Pattern[$CellContext`x, 
             Blank[]], 
            Pattern[$CellContext`y, 
             Blank[]]] := {
            Cos[2 Pi - 2 $CellContext`x (Pi/$CellContext`y) + Pi/2], 
            Sin[2 Pi - 2 $CellContext`x (Pi/$CellContext`y) + Pi/2]}]}}]; 
...
Cell[TextData[{
 "This is a visual map of multiplicative inverses modulo ",
 Cell[BoxData[
 ...
 " are placed clockwise on a circular number line with ",
 Cell[BoxData[
  FormBox["0", TraditionalForm]], "InlineMath"],
 " at the top. Two integers that are inverses modulo ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 " are connected by an arrow. An integer that is its own inverse is marked by \
a colored dot. Those integers that have no inverse modulo ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 " are not marked."
}], "ManipulateCaption"],
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"n", "=", "24"}], TraditionalForm]], "InlineMath"],
 ", all integers that have inverses are inverses of themselves"
}], "DetailNotes",
 CellID->6112106],

Cell[TextData[{
 "Snapshot 2: for some values of ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 ", the inverse map demonstrates four-fold rotational symmetry"
}], "DetailNotes",
 CellID->165012393],

Cell[TextData[{
 "Snapshot 3: for prime ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 ", all integers have inverses, so the map is much more detailed"
}], "DetailNotes",
 CellID->4833605],
...
Cell[TextData[{
 ButtonBox["Modular Inverse",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/ModularInverse.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/ModularInverse.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ModularInverses&version=0005"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ModularInverses/ModularInverses-source.\
...
Cell[TextData[{
 "\"",
 ButtonBox["Modular Inverses",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularInverses/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularInverses/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ModularInverses/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularInverses/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularInverses/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Aaron Dunigan AtLee",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Aaron+Dunigan+\
AtLee"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Aaron+Dunigan+AtLee"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39289, 698, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39550, 707, 1925, 44, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48844, 935, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75512, 1504},
 {"Copyright", 75707, 1509}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34951, 592, 3515, 80, 70, "Output",
 CellID->83797561],
Cell[38469, 674, 817, 22, 70, "ManipulateCaption"],
Cell[39289, 698, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39550, 707, 1925, 44, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41478, 753, 33, 0, 70, "DetailsSection"],
Cell[41514, 755, 226, 7, 70, "DetailNotes",
 CellID->6112106],
Cell[41743, 764, 218, 6, 70, "DetailNotes",
 CellID->165012393],
Cell[41964, 772, 209, 6, 70, "DetailNotes",
 CellID->4833605],
Cell[42176, 780, 43, 1, 70, "DetailNotes",
 CellID->340193867],
Cell[42222, 783, 44, 0, 70, "RelatedLinksSection"],
Cell[42269, 785, 635, 21, 70, "RelatedLinks",
 CellID->915724323],
Cell[42907, 808, 4784, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47694, 899, 45, 0, 70, "CitationSection"],
Cell[47742, 901, 754, 20, 70, "Citations"],
Cell[48499, 923, 342, 10, 70, "Author"],
Cell[48844, 935, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature rSq8ozw7xlB5tu7sm4MKaaZE *)
