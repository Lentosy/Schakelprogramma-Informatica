...
NotebookDataLength[     82299,       1688]
NotebookOptionsPosition[     55497,       1114]
NotebookOutlinePosition[     81544,       1669]
CellTagsIndexPosition[     81471,       1664]
WindowTitle->Finding the Least Common Multiple of Two Numbers by Factoring
WindowFrame->Normal*)
...
Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`n1$$ = 24, $CellContext`n2$$ = 180, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n1$$], 24, "number 1"}, 0, 1000, 1}, {{
       Hold[$CellContext`n2$$], 180, "number 2"}, 0, 1000, 1}}, 
    Typeset`size$$ = {508., {165., 172.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`n1$24064$$ = 0, $CellContext`n2$24065$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`n1$$ = 24, $CellContext`n2$$ = 180}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n1$$, $CellContext`n1$24064$$, 0], 
        Hold[$CellContext`n2$$, $CellContext`n2$24065$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Column[{
          Grid[{{
             $CellContext`plotFactorTree[$CellContext`n1$$, 
              ImageSize -> {250, 250}], 
             $CellContext`plotFactorTree[$CellContext`n2$$, 
              ImageSize -> {250, 250}]}, 
            Map[Pane[#, {250, 30}, Alignment -> Center]& , 
             $CellContext`highlightHighestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$]]}], 
          Text[
           Pane[
            If[
             Or[$CellContext`n1$$ === 0, $CellContext`n2$$ === 0], 
             Column[{
               Pane["", {500, 15}], 
               Pane[
                Row[{
                  
                  Row[{"lcm(", $CellContext`n1$$, ", ", $CellContext`n2$$, 
                    ")", " = "}], 
                  Style[0, Red]}, " "], {500, 15}, 
                Alignment -> {Center, Bottom}]}], 
             Column[{
               Pane[
                Row[{"the \[ThinSpace]highest-degree", 
                  If[Length[
                    $CellContext`highestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$]] === 1, "factor", "factors"], "of", $CellContext`n1$$, 
                  "and", $CellContext`n2$$, 
                  If[Length[
                    $CellContext`highestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$]] === 1, "is", "are"], 
                  Row[{
                    $CellContext`formatFactorization[
                    Map[Style[#, Red]& , 
                    $CellContext`highestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$], {-1}]]}, ", "]}, " \[ThinSpace]"], {500, 15}, 
                Alignment -> {Center, Bottom}], 
               Pane[
                Row[{
                  ...
                  Row[{
                    ...
                    Map[Style[#, Red]& , 
                    $CellContext`highestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$], {-1}]]}, "\[Times]"], "=", 
                  Style[
                   Apply[Times, 
                    Apply[Power, 
                    $CellContext`highestDegreeFactors[$CellContext`n1$$, \
$CellContext`n2$$], {1}]], Red]}, "  "], {500, 15}, 
                Alignment -> {Center, Bottom}]}, Center]], {500, 40}, 
            Alignment -> {Center, Top}]]}, Center]], 
      "Specifications" :> {{{$CellContext`n1$$, 24, "number 1"}, 0, 1000, 1, 
         Appearance -> "Labeled"}, {{$CellContext`n2$$, 180, "number 2"}, 0, 
         1000, 1, Appearance -> "Labeled"}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{553., {224., 229.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`plotFactorTree[
          Pattern[$CellContext`n, 
           Blank[]], 
          Pattern[$CellContext`opts, 
           BlankNullSequence[]]] := TreeForm[
          $CellContext`carryDownPrimes[
           $CellContext`primeFactorTree[$CellContext`n]], 
          VertexRenderingFunction -> (Style[
            Text[#2, #, Background -> White], 
            16]& ), $CellContext`opts], $CellContext`carryDownPrimes[
          Pattern[$CellContext`expr, 
           Blank[]]] := FixedPoint[MapAt[#[#]& , #, 
           Cases[
            Position[#, 
             PatternTest[
              Pattern[$CellContext`n, 
               Blank[]], PrimeQ], Heads -> False], 
            Condition[
             Pattern[$CellContext`pos, 
              Blank[]], Length[$CellContext`pos] < 
             Depth[#] - 
              1]]]& , $CellContext`expr], $CellContext`primeFactorTree[
          Pattern[$CellContext`n, 
           Blank[]]] := First[
          FixedPoint[If[Length[#] > 1, 
            Append[
             Drop[#, -2], 
             Apply[(If[
                IntegerQ[
...
$CellContext`highlightHighestDegreeFactors[
          ...
          Optional[
           Pattern[$CellContext`color, 
            Blank[]], 
           RGBColor[1, 0, 0]]] := Function[$CellContext`factorLists, 
          Map[$CellContext`formatFactorization, 
           MapAt[Map[Style[#, Red]& , #]& , $CellContext`factorLists, 
            Map[
             Function[$CellContext`factor, 
              First[
               Position[$CellContext`factorLists, $CellContext`factor]]], 
             Map[Last, 
              Split[
               Sort[
                Flatten[$CellContext`factorLists, 1]], First[#] === 
               First[#2]& ]]]]]][{
           FactorInteger[$CellContext`n1], 
           FactorInteger[$CellContext`n2]}], $CellContext`formatFactorization[
          Pattern[$CellContext`factorization, 
           Blank[]]] := (If[Length[#] == 1, 
          Part[#, 1], 
          Row[#, "\[Times]"]]& )[
          Apply[Replace[
            Superscript[#, #2], Superscript[#, 
              Alternatives[
               Style[1, 
                Blank[]], 1]] -> #]& , $CellContext`factorization, {1}]], 
        Attributes[Superscript] = {
         NHoldRest, ReadProtected}, $CellContext`highestDegreeFactors[
          Pattern[$CellContext`n1, 
           Blank[]], 
          Pattern[$CellContext`n2, 
           Blank[]], 
          ...
          Map[Last, 
           Split[
            ...
            First[#2]& ]]][{
           FactorInteger[$CellContext`n1], 
           FactorInteger[$CellContext`n2]}]}; Typeset`initDone$$ = True); 
     ReleaseHold[
       HoldComplete[{$CellContext`primeFactorTree[
           Pattern[$CellContext`n, 
            Blank[]]] := First[
           FixedPoint[If[Length[#] > 1, 
             Append[
            ...
            Flatten[
             Map[Table[
               First[#], {
                Last[#]}]& , 
              FactorInteger[$CellContext`n]]]]], $CellContext`carryDownPrimes[
           Pattern[$CellContext`expr, 
            Blank[]]] := FixedPoint[MapAt[#[#]& , #, 
            Cases[
             Position[#, 
             ...
             Condition[
              Pattern[$CellContext`pos, 
               Blank[]], Length[$CellContext`pos] < 
              Depth[#] - 
               1]]]& , $CellContext`expr], $CellContext`plotFactorTree[
           Pattern[$CellContext`n, 
            Blank[]], 
           Pattern[$CellContext`opts, 
            BlankNullSequence[]]] := TreeForm[
           ...
           VertexRenderingFunction -> (Style[
             Text[#2, #, Background -> White], 
             16]& ), $CellContext`opts], $CellContext`formatFactorization[
           Pattern[$CellContext`factorization, 
            Blank[]]] := (If[Length[#] == 1, 
           Part[#, 1], 
           Row[#, "\[Times]"]]& )[
           Apply[Replace[
             Superscript[#, #2], Superscript[#, 
               Alternatives[
                Style[1, 
                 Blank[]], 1]] -> #]& , $CellContext`factorization, {
            1}]], $CellContext`highestDegreeFactors[
           Pattern[$CellContext`n1, 
            Blank[]], 
           Pattern[$CellContext`n2, 
            Blank[]], 
           Optional[
            Pattern[$CellContext`color, 
             Blank[]], Red]] := Function[$CellContext`factorLists, 
           Map[Last, 
            Split[
             Sort[
              Flatten[$CellContext`factorLists, 1]], First[#] === 
...
Cell["\<\
You can find the least common multiple (LCM) of two numbers by multiplying \
together the highest power of each factor found in either number.\
\>", "ManipulateCaption"],

Cell["DETAILS", "DetailsSection"],

Cell[TextData[{
 "A faster way to compute the LCM of two numbers ",
 Cell[BoxData[
 ...
 ", which can take advantage of the efficiency of the Euclidean algorithm."
}], "DetailNotes",
 CellID->1177545959],
...
Cell[TextData[{
 ButtonBox["Multiple",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/Multiple.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Least Common Multiple",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/LeastCommonMultiple.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
FindingTheLeastCommonMultipleOfTwoNumbersByFactoring&version=0008"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FindingTheLeastCommonMultipleOfTwoNumbersByFactoring/\
FindingTheLeastCommonMultipleOfTwoNumbersByFactoring-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Finding the Least Common Multiple of Two Numbers by Factoring",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
FindingTheLeastCommonMultipleOfTwoNumbersByFactoring/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
FindingTheLeastCommonMultipleOfTwoNumbersByFactoring/"],
 "\"",
...
CellTagsIndex->{
 "Copyright"->{
  Cell[54675, 1089, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Copyright", 81379, 1658}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[625, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34956, 590, 90, 2, 70, "DemoTitle"],
Cell[35049, 594, 10784, 262, 70, "Output",
 CellID->110359035],
Cell[45836, 858, 179, 3, 70, "ManipulateCaption"],
Cell[46018, 863, 33, 0, 70, "DetailsSection"],
Cell[46054, 865, 561, 18, 70, "DetailNotes",
 CellID->1177545959],
Cell[46618, 885, 44, 0, 70, "RelatedLinksSection"],
Cell[46665, 887, 557, 20, 70, "RelatedLinks",
 CellID->1953125808],
Cell[47225, 909, 581, 20, 70, "RelatedLinks",
 CellID->1897910661],
Cell[47809, 931, 578, 20, 70, "RelatedLinks",
 CellID->1451589110],
Cell[48390, 953, 4899, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53292, 1046, 45, 0, 70, "CitationSection"],
Cell[53340, 1048, 1002, 27, 70, "Citations"],
Cell[54345, 1077, 327, 10, 70, "Author"],
Cell[54675, 1089, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature CTEZFULJ1t4n9wAE3S8YvSO2 *)
