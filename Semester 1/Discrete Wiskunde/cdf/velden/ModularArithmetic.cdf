...
NotebookDataLength[     84030,       1667]
NotebookOptionsPosition[     57000,       1087]
NotebookOutlinePosition[     83245,       1648]
CellTagsIndexPosition[     83134,       1642]
WindowTitle->Modular Arithmetic
WindowFrame->Normal*)
...
Cell["Modular Arithmetic", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`modulus$$ = 5, $CellContext`operation$$ = 
    Plus, $CellContext`restriction$$ = None, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{
      Hold[$CellContext`modulus$$], 5, 25, 1}, {{
       Hold[$CellContext`restriction$$], None}, {
      None -> "none", $CellContext`NonZero -> 
       "nonzero", $CellContext`UnitsOnly -> "units only"}}, {{
       Hold[$CellContext`operation$$], Plus}, {
      Plus -> "plus", Times -> "times", Power -> 
       "power", $CellContext`SumOfSquares -> "sum of squares"}}}, 
    Typeset`size$$ = {350., {172.375, 177.625}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`modulus$25249$$ = 
    0, $CellContext`restriction$25250$$ = 
    False, $CellContext`operation$25251$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`modulus$$ = 5, $CellContext`operation$$ = 
        Plus, $CellContext`restriction$$ = None}, "ControllerVariables" :> {
        Hold[$CellContext`modulus$$, $CellContext`modulus$25249$$, 0], 
        Hold[$CellContext`restriction$$, $CellContext`restriction$25250$$, 
         False], 
        Hold[$CellContext`operation$$, $CellContext`operation$25251$$, 
         False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        $CellContext`ModularDisplay[
         $CellContext`operation$$[$CellContext`a, $CellContext`b], \
$CellContext`a, $CellContext`b, $CellContext`modulus$$, \
$CellContext`restriction$$], {350, 350}], 
      "Specifications" :> {{$CellContext`modulus$$, 5, 25, 1, Appearance -> 
         "Labeled"}, {{$CellContext`restriction$$, None}, {
         None -> "none", $CellContext`NonZero -> 
          "nonzero", $CellContext`UnitsOnly -> 
          "units only"}}, {{$CellContext`operation$$, Plus}, {
         Plus -> "plus", Times -> "times", Power -> 
          "power", $CellContext`SumOfSquares -> "sum of squares"}}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{395., {241., 246.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`ModularDisplay[
          ...
          Pattern[$CellContext`res, 
           Blank[]]] := 
        Block[{$CellContext`i, $CellContext`j, $CellContext`w, \
$CellContext`var, $CellContext`units, $CellContext`v1}, $CellContext`var = \
$CellContext`res; $CellContext`v1 = 
           If[$CellContext`form === $CellContext`b^$CellContext`a, True, 
             False]; Show[
            Graphics[
             Flatten[
              Table[
               Which[
                ...
                And[$CellContext`form === $CellContext`b^$CellContext`a, \
$CellContext`i == 0, $CellContext`j == 0], {}, 
                And[$CellContext`var === $CellContext`UnitsOnly, 
                 Or[
                 GCD[$CellContext`i, $CellContext`n] > 1, 
                  GCD[$CellContext`j, $CellContext`n] > 1]], {}, 
                And[$CellContext`var === $CellContext`NonZero, 
                 Or[$CellContext`i == 0, $CellContext`j == 0]], {}, 
                Mod[$CellContext`w = 
                  ReplaceAll[$CellContext`form, {$CellContext`a -> \
$CellContext`i, $CellContext`b -> $CellContext`j}], $CellContext`n] == 0, {
                 GrayLevel[0], 
                 
                 Polygon[{{$CellContext`i, $CellContext`n - $CellContext`j - 
                    1}, {$CellContext`i + 1, $CellContext`n - $CellContext`j - 
                    1}, {$CellContext`i + 
                    1, $CellContext`n - $CellContext`j}, {$CellContext`i, \
$CellContext`n - $CellContext`j}}]}, 
                Mod[$CellContext`w = 
                  ReplaceAll[$CellContext`form, {$CellContext`a -> \
$CellContext`i, $CellContext`b -> $CellContext`j}], $CellContext`n] == 1, 
                If[True, {
                  GrayLevel[0], 
                  
                  Line[{{$CellContext`i, $CellContext`n - $CellContext`j - 
                    1}, {$CellContext`i + 1, $CellContext`n - $CellContext`j - 
                    1}, {$CellContext`i + 
                    1, $CellContext`n - $CellContext`j}, {$CellContext`i, \
$CellContext`n - $CellContext`j}, {$CellContext`i, $CellContext`n - \
$CellContext`j - 1}}]}, {
                  GrayLevel[1], 
                  ...
                  Polygon[{{$CellContext`i, $CellContext`n - $CellContext`j - 
                    ...
                    1}, {$CellContext`i + 
                    1, $CellContext`n - $CellContext`j}, {$CellContext`i, \
$CellContext`n - $CellContext`j}}]}], True, {
                 Hue[
                 Mod[$CellContext`w = 
                    ReplaceAll[$CellContext`form, {$CellContext`a -> \
$CellContext`i, $CellContext`b -> $CellContext`j}], \
$CellContext`n]/$CellContext`n], 
                 
                 Rectangle[{$CellContext`i, $CellContext`n - $CellContext`j}, \
{$CellContext`i + 1, $CellContext`n - ($CellContext`j + 
                   1)}]}], {$CellContext`i, $CellContext`n - 1, 
                0, -1}, {$CellContext`j, $CellContext`n - 1, 0, -1}]]], 
            Graphics[
             Table[
              
              Text[$CellContext`i, {$CellContext`i + 0.5, $CellContext`n + 
                0.5}], {$CellContext`i, 0, $CellContext`n - 1}]], 
            Graphics[
             Table[
              
              Text[$CellContext`n - $CellContext`i - 
               1, {-0.5, $CellContext`i + 0.5}], {$CellContext`i, 
               0, $CellContext`n - 1}]], 
            Graphics[
             Flatten[{
               Table[{
                 Hue[$CellContext`j/$CellContext`n], 
                 Rectangle[{$CellContext`n + 
                   2, $CellContext`n - $CellContext`j}, {$CellContext`n + 
                   3, $CellContext`n - ($CellContext`j + 
                   1)}]}, {$CellContext`j, $CellContext`n - 1, 2, -1}], {
                GrayLevel[0], 
                
                Polygon[{{$CellContext`n + 
                   2, $CellContext`n}, {$CellContext`n + 2, $CellContext`n - 
                   1}, {$CellContext`n + 3, $CellContext`n - 
                   1}, {$CellContext`n + 3, $CellContext`n}}]}}]], 
            Graphics[
             Table[
              
              Text[$CellContext`n - $CellContext`i - 
               1, {$CellContext`n + 3.5, $CellContext`i + 
                0.5}], {$CellContext`i, 0, $CellContext`n - 1}]], AspectRatio -> 
            Automatic]], $CellContext`SumOfSquares[
          Pattern[$CellContext`a, 
           Blank[]], 
          Pattern[$CellContext`b, 
           Blank[]]] := $CellContext`a^2 + $CellContext`b^2}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`ModularDisplay[
           Pattern[$CellContext`form, 
            Blank[]], 
           Pattern[$CellContext`b, 
            Blank[]], 
...
$CellContext`j}, {$CellContext`i + 1, $CellContext`n - ($CellContext`j + 
                    1)}]}], {$CellContext`i, $CellContext`n - 1, 
                 0, -1}, {$CellContext`j, $CellContext`n - 1, 0, -1}]]], 
             Graphics[
              Table[
             ...
             Graphics[
              Table[
               ...
               Text[$CellContext`n - $CellContext`i - 
                1, {$CellContext`n + 3.5, $CellContext`i + 
                 0.5}], {$CellContext`i, 0, $CellContext`n - 1}]], 
             AspectRatio -> Automatic]], $CellContext`SumOfSquares[
           Pattern[$CellContext`a, 
            Blank[]], 
           Pattern[$CellContext`b, 
            Blank[]]] := $CellContext`a^2 + $CellContext`b^2}]]; 
...
Cell[TextData[{
 "This visually illustrates various properties of modular arithmetic by \
creating an \"operation table\" modulo ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 ", where 0 is represented by black, 1 by white, and other values by \
intermediate colors. The allowed numbers can be restricted to be nonzero or \
the units modulo ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 ", and the operations are modular addition, subtraction, powers, and sums of \
squares."
}], "ManipulateCaption"],
...
Cell[TextData[{
 "This visual display of modular arithmetic can be used to illustrate \
different principles of modular arithmetic (such as the existence of additive \
or multiplicative inverses modulo ",
 Cell[BoxData[
  FormBox["n", TraditionalForm]], "InlineMath"],
 "). Because 0 is always represented by black and 1 by white, it makes these \
values easy to spot in the table.  For example, to determine which numbers \
have multiplicative inverses mod 12, you simply need to move the modulus \
slider to 12, the operation to times, and then determine which rows of the \
table have the white \"1\" square. By using this Demonstration, you can see a \
wide range of values and different operations for modular arithmetic, which \
is quite useful for those beginning to study algebra/number theory."
}], "DetailNotes",
 CellID->183986959],
...
Cell[TextData[{
 ButtonBox["Modular Arithmetic",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/ModularArithmetic.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
ModularArithmetic&version=0010"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/ModularArithmetic/ModularArithmetic-\
...
Cell[TextData[{
 ...
 ButtonBox["Modular Arithmetic",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularArithmetic/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularArithmetic/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/ModularArithmetic/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/ModularArithmetic/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/ModularArithmetic/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Christopher Moretti",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Christopher+\
Moretti"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Christopher+Moretti"]
}], "Author",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[47762, 867, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[48023, 876, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[56178, 1062, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 82848, 1631},
 {"Copyright", 83042, 1636}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34955, 592, 12258, 259, 70, "Output",
 CellID->54505212],
Cell[47216, 853, 543, 12, 70, "ManipulateCaption"],
Cell[47762, 867, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48023, 876, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48717, 893, 33, 0, 70, "DetailsSection"],
Cell[48753, 895, 842, 14, 70, "DetailNotes",
 CellID->183986959],
Cell[49598, 911, 44, 0, 70, "RelatedLinksSection"],
Cell[49645, 913, 575, 20, 70, "RelatedLinks",
 CellID->265081198],
Cell[50223, 935, 4790, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55016, 1026, 45, 0, 70, "CitationSection"],
Cell[55064, 1028, 766, 20, 70, "Citations"],
Cell[55833, 1050, 342, 10, 70, "Author"],
Cell[56178, 1062, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature lQqaFjtAnUhTZvAzYnhLUitO *)
